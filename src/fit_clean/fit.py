...
def main(options,args):
    ...
    while i < len(ptBins):
        ...
        fitDebug('abs(etaPhot)<1.4442  && ptPhot>'+ptBins[i]['ptMin']+'. && ptPhot<'+ptBins[i]["ptMax"]+'.', 'fit_EB_bg_WP095_pt'+ptBins[i]['ptMin']+'_'+ptBins[i]['ptMax'], ptBins[i]['hlt'], 0, options.outdir, options.isoWeight, options.isFPR)
