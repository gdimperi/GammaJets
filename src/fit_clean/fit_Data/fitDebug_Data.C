...
void fitDebug_Data(string cut, string filename, string hlt, string ptMin, string ptMax){
  ...
  TFile* f_ws_sig = new TFile((workdir_mc+"workspace_fit_EB_sig_WP095_pt"+ptMin+"_"+ptMax+".root").c_str(), "READ");
  TFile* f_ws_bg = new TFile((workdir_mc+"workspace_fit_EB_bg_WP095_pt"+ptMin+"_"+ptMax+".root").c_str(), "READ");
  ...
  //all fixed configuration, TO CHANGE 
