...
//=========  (Sat Sep 27 22:34:46 2014) by ROOT version5.32/00
   ...
   ptPhot_mc_Z_EE__1->SetBinContent(9,0.46424);
   ptPhot_mc_Z_EE__1->SetBinContent(10,0.3206329);
   ptPhot_mc_Z_EE__1->SetBinContent(11,0.1262979);
   ptPhot_mc_Z_EE__1->SetBinContent(12,0.05770441);
   ptPhot_mc_Z_EE__1->SetBinContent(13,0.03112478);
   ptPhot_mc_Z_EE__1->SetBinError(9,0.00144298);
   ptPhot_mc_Z_EE__1->SetBinError(10,0.001182136);
   ptPhot_mc_Z_EE__1->SetBinError(11,0.000740401);
   ptPhot_mc_Z_EE__1->SetBinError(12,0.0005036819);
   ptPhot_mc_Z_EE__1->SetBinError(13,0.000371561);
   ptPhot_mc_Z_EE__1->SetEntries(259310);
   ...
   ptPhot_mc_Z_EE__3->SetBinContent(9,0.46424);
   ptPhot_mc_Z_EE__3->SetBinContent(10,0.3206329);
   ptPhot_mc_Z_EE__3->SetBinContent(11,0.1262979);
   ptPhot_mc_Z_EE__3->SetBinContent(12,0.05770441);
   ptPhot_mc_Z_EE__3->SetBinContent(13,0.03112478);
   ptPhot_mc_Z_EE__3->SetBinError(9,0.00144298);
   ptPhot_mc_Z_EE__3->SetBinError(10,0.001182136);
   ptPhot_mc_Z_EE__3->SetBinError(11,0.000740401);
   ptPhot_mc_Z_EE__3->SetBinError(12,0.0005036819);
   ptPhot_mc_Z_EE__3->SetBinError(13,0.000371561);
   ptPhot_mc_Z_EE__3->SetMinimum(0);
   ptPhot_mc_Z_EE__3->SetMaximum(0.649936);
   ptPhot_mc_Z_EE__3->SetEntries(259310);
   ...
   TLegend *leg = new TLegend(0,-1.280437e+117,4.031576e-321,2.371515e-322,NULL,"brNDC");
   leg->SetBorderSize(0);
   leg->SetTextFont(62);
