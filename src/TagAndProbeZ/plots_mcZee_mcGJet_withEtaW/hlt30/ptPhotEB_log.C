...
//=========  (Sat Sep 27 22:34:50 2014) by ROOT version5.32/00
   ...
   ptPhot->Range(-48.75,-0.06530648,326.25,0.5877582);
...
// ------------>Primitives in pad: pad1
   ...
   ptPhot_mc_Z_EB__16->SetBinContent(9,0.502934);
   ptPhot_mc_Z_EB__16->SetBinContent(10,0.3036157);
   ptPhot_mc_Z_EB__16->SetBinContent(11,0.1127219);
   ptPhot_mc_Z_EB__16->SetBinContent(12,0.05205825);
   ptPhot_mc_Z_EB__16->SetBinContent(13,0.02867012);
   ptPhot_mc_Z_EB__16->SetBinError(9,0.0008587395);
   ptPhot_mc_Z_EB__16->SetBinError(10,0.0006618503);
   ptPhot_mc_Z_EB__16->SetBinError(11,0.0004039774);
   ptPhot_mc_Z_EB__16->SetBinError(12,0.0002758663);
   ptPhot_mc_Z_EB__16->SetBinError(13,0.0002058331);
   ptPhot_mc_Z_EB__16->SetMinimum(1.133876e-07);
   ptPhot_mc_Z_EB__16->SetMaximum(2.816431);
   ptPhot_mc_Z_EB__16->SetEntries(787500);
   ...
   ptPhot_mc_Z_EB__18->SetBinContent(9,0.502934);
   ptPhot_mc_Z_EB__18->SetBinContent(10,0.3036157);
   ptPhot_mc_Z_EB__18->SetBinContent(11,0.1127219);
   ptPhot_mc_Z_EB__18->SetBinContent(12,0.05205825);
   ptPhot_mc_Z_EB__18->SetBinContent(13,0.02867012);
   ptPhot_mc_Z_EB__18->SetBinError(9,0.0008587395);
   ptPhot_mc_Z_EB__18->SetBinError(10,0.0006618503);
   ptPhot_mc_Z_EB__18->SetBinError(11,0.0004039774);
   ptPhot_mc_Z_EB__18->SetBinError(12,0.0002758663);
   ptPhot_mc_Z_EB__18->SetBinError(13,0.0002058331);
   ptPhot_mc_Z_EB__18->SetMinimum(1.133876e-07);
   ptPhot_mc_Z_EB__18->SetMaximum(2.816431);
   ptPhot_mc_Z_EB__18->SetEntries(787500);
...
// ------------>Primitives in pad: pad2
   ...
   ratio->SetBinContent(9,1.269311);
   ratio->SetBinContent(10,1.201873);
   ratio->SetBinContent(11,0.6835639);
   ratio->SetBinContent(12,0.4742633);
   ratio->SetBinContent(13,0.3748441);
   ratio->SetBinError(9,0.007909723);
   ratio->SetBinError(10,0.008741387);
   ratio->SetBinError(11,0.00588844);
   ratio->SetBinError(12,0.004745607);
   ratio->SetBinError(13,0.004444463);
   ratio->SetMinimum(0.2);
   ratio->SetMaximum(3);
   ratio->SetEntries(74243.28);
   ratio->SetStats(0);
