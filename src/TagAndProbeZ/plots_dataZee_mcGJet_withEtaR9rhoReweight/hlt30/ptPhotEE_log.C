...
// ------------>Primitives in pad: pad1
   ...
   ptPhot_mc_Z_EE__4->SetBinContent(5,0.7979664);
   ptPhot_mc_Z_EE__4->SetBinContent(6,0.1723692);
   ptPhot_mc_Z_EE__4->SetBinContent(7,0.02966437);
   ptPhot_mc_Z_EE__4->SetBinError(5,0.003137424);
   ptPhot_mc_Z_EE__4->SetBinError(6,0.001451444);
   ptPhot_mc_Z_EE__4->SetBinError(7,0.0006250939);
   ptPhot_mc_Z_EE__4->SetMinimum(3.420085e-07);
   ptPhot_mc_Z_EE__4->SetMaximum(4.468612);
   ptPhot_mc_Z_EE__4->SetEntries(460481);
   ...
   ptPhot_mc_Z_EE__6->SetBinContent(5,0.7979664);
   ptPhot_mc_Z_EE__6->SetBinContent(6,0.1723692);
   ptPhot_mc_Z_EE__6->SetBinContent(7,0.02966437);
   ptPhot_mc_Z_EE__6->SetBinError(5,0.003137424);
   ptPhot_mc_Z_EE__6->SetBinError(6,0.001451444);
   ptPhot_mc_Z_EE__6->SetBinError(7,0.0006250939);
   ptPhot_mc_Z_EE__6->SetMinimum(3.420085e-07);
   ptPhot_mc_Z_EE__6->SetMaximum(4.468612);
   ptPhot_mc_Z_EE__6->SetEntries(460481);
...
// ------------>Primitives in pad: pad2
   ...
   ratio->SetBinContent(5,1.195863);
   ratio->SetBinContent(6,0.6591387);
   ratio->SetBinContent(7,0.4165114);
   ratio->SetBinError(5,0.007859116);
   ratio->SetBinError(6,0.007204984);
   ratio->SetBinError(7,0.01002156);
   ratio->SetMinimum(0.2);
   ratio->SetMaximum(3);
   ratio->SetEntries(24098.79);
   ratio->SetStats(0);
