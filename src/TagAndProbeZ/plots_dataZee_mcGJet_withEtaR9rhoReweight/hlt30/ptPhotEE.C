...
//=========  (Tue Dec  2 08:44:57 2014) by ROOT version5.32/00
   ...
   ptPhot_mc_Z_EE__1->SetBinContent(5,0.7979664);
   ptPhot_mc_Z_EE__1->SetBinContent(6,0.1723692);
   ptPhot_mc_Z_EE__1->SetBinContent(7,0.02966437);
   ptPhot_mc_Z_EE__1->SetBinError(5,0.003137424);
   ptPhot_mc_Z_EE__1->SetBinError(6,0.001451444);
   ptPhot_mc_Z_EE__1->SetBinError(7,0.0006250939);
   ptPhot_mc_Z_EE__1->SetEntries(460481);
   ...
   ptPhot_mc_Z_EE__3->SetBinContent(5,0.7979664);
   ptPhot_mc_Z_EE__3->SetBinContent(6,0.1723692);
   ptPhot_mc_Z_EE__3->SetBinContent(7,0.02966437);
   ptPhot_mc_Z_EE__3->SetBinError(5,0.003137424);
   ptPhot_mc_Z_EE__3->SetBinError(6,0.001451444);
   ptPhot_mc_Z_EE__3->SetBinError(7,0.0006250939);
   ptPhot_mc_Z_EE__3->SetMinimum(0);
   ptPhot_mc_Z_EE__3->SetMaximum(1.117153);
   ptPhot_mc_Z_EE__3->SetEntries(460481);
   ...
   TLegend *leg = new TLegend(0,0,3.960686e-315,5.288973e-320,NULL,"brNDC");
   leg->SetBorderSize(0);
   leg->SetTextFont(62);
