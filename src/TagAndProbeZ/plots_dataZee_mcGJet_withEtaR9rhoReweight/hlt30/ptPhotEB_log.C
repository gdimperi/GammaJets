...
//=========  (Tue Dec  2 08:44:59 2014) by ROOT version5.32/00
   ...
   ptPhot->Range(-97.49999,-0.105184,652.5,0.9466561);
...
// ------------>Primitives in pad: pad1
   ...
   ptPhot_mc_Z_EB__10->SetBinContent(5,0.810236);
   ptPhot_mc_Z_EB__10->SetBinContent(6,0.1624992);
   ptPhot_mc_Z_EB__10->SetBinContent(7,0.02726485);
   ptPhot_mc_Z_EB__10->SetBinError(5,0.001183519);
   ptPhot_mc_Z_EB__10->SetBinError(6,0.0005308849);
   ptPhot_mc_Z_EB__10->SetBinError(7,0.0002196517);
   ptPhot_mc_Z_EB__10->SetMinimum(1.223801e-07);
   ptPhot_mc_Z_EB__10->SetMaximum(4.537322);
   ptPhot_mc_Z_EB__10->SetEntries(825237);
   ...
   ptPhot_mc_Z_EB__12->SetBinContent(5,0.810236);
   ptPhot_mc_Z_EB__12->SetBinContent(6,0.1624992);
   ptPhot_mc_Z_EB__12->SetBinContent(7,0.02726485);
   ptPhot_mc_Z_EB__12->SetBinError(5,0.001183519);
   ptPhot_mc_Z_EB__12->SetBinError(6,0.0005308849);
   ptPhot_mc_Z_EB__12->SetBinError(7,0.0002196517);
   ptPhot_mc_Z_EB__12->SetMinimum(1.223801e-07);
   ptPhot_mc_Z_EB__12->SetMaximum(4.537322);
   ptPhot_mc_Z_EB__12->SetEntries(825237);
...
// ------------>Primitives in pad: pad2
   ...
   ratio->SetBinContent(5,1.224235);
   ratio->SetBinContent(6,0.611354);
   ratio->SetBinContent(7,0.3767548);
   ratio->SetBinError(5,0.00539066);
   ratio->SetBinError(6,0.003892172);
   ratio->SetBinError(7,0.004565116);
   ratio->SetMinimum(0.2);
   ratio->SetMaximum(3);
   ratio->SetEntries(75243.33);
   ratio->SetStats(0);
