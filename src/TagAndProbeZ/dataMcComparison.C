{  
  ...
  // mc distributions
  TFile* inFileMC=TFile::Open("DYJetsToLL_M-50_madgraph_tagTight_HLT__siR9Weights.root");                                              
  TTree* inTreeMC=(TTree*)inFileMC->Get("myTaPDir/myTree");

  // data distributions
  TFile* inFileData=TFile::Open("DoubleElectron_Run2012All_tagTight_HLT__siR9Weight.root");
  ...
  inTreeMC->Draw("probe_charged03    >> h1_ch03_EB_Mc(120, 0., 30.)",          "puW*(abs(probe_eta)<1.5)");
  inTreeMC->Draw("probe_neutral03    >> h1_neu03_EB_Mc(120, 0., 30.)",         "puW*(abs(probe_eta)<1.5)");
  inTreeMC->Draw("probe_photon03     >> h1_ph03_EB_Mc(120, 0., 30.)",          "puW*(abs(probe_eta)<1.5)");
  ...
  inTreeMC->Draw("probe_charged03    >> h1_ch03_EE_Mc(120, 0., 30.)",          "puW*(abs(probe_eta)>1.5)");
  inTreeMC->Draw("probe_neutral03    >> h1_neu03_EE_Mc(120, 0., 30.)",         "puW*(abs(probe_eta)>1.5)");
  inTreeMC->Draw("probe_photon03     >> h1_ph03_EE_Mc(120, 0., 30.)",          "puW*(abs(probe_eta)>1.5)");
  ...
  inTreeData->Draw("probe_charged03    >> h1_ch03_EB_Data(120, 0., 30.)",         "1.*(abs(probe_eta)<1.5)");
  inTreeData->Draw("probe_neutral03    >> h1_neu03_EB_Data(120, 0., 30.)",        "1.*(abs(probe_eta)<1.5)");
  inTreeData->Draw("probe_photon03     >> h1_ph03_EB_Data(120, 0., 30.)",         "1.*(abs(probe_eta)<1.5)");
  ...
  inTreeData->Draw("probe_charged03    >> h1_ch03_EE_Data(120, 0., 30.)",          "1.*(abs(probe_eta)>1.5)");
  inTreeData->Draw("probe_neutral03    >> h1_neu03_EE_Data(120, 0., 30.)",         "1.*(abs(probe_eta)>1.5)");
  inTreeData->Draw("probe_photon03     >> h1_ph03_EE_Data(120, 0., 30.)",          "1.*(abs(probe_eta)>1.5)");
  ...
  h1_ch03_EB_Data       -> Sumw2();     
  h1_neu03_EB_Data      -> Sumw2();     
  h1_ph03_EB_Data       -> Sumw2();       
  ...
  h1_ch03_EE_Data       -> Sumw2();     
  h1_neu03_EE_Data      -> Sumw2();     
  h1_ph03_EE_Data       -> Sumw2();     
  ...
  h1_ch03_EB_Mc       -> GetXaxis()->SetTitle("chargedIso03");     
  h1_neu03_EB_Mc      -> GetXaxis()->SetTitle("neutralIso03");
  h1_ph03_EB_Mc       -> GetXaxis()->SetTitle("photonIso03");     
  ...
  h1_ch03_EB_Data       -> GetXaxis()->SetTitle("chargedIso03");     
  h1_neu03_EB_Data      -> GetXaxis()->SetTitle("neutralIso03");
  h1_ph03_EB_Data       -> GetXaxis()->SetTitle("photonIso03");     
  ...
  h1_ch03_EE_Mc       -> GetXaxis()->SetTitle("chargedIso03");     
  h1_neu03_EE_Mc      -> GetXaxis()->SetTitle("neutralIso03");     
  h1_ph03_EE_Mc       -> GetXaxis()->SetTitle("photonIso03");     
  ...
  h1_ch03_EE_Data       -> GetXaxis()->SetTitle("chargedIso03");     
  h1_neu03_EE_Data      -> GetXaxis()->SetTitle("neutralIso03");     
  h1_ph03_EE_Data       -> GetXaxis()->SetTitle("photonIso03");     
  ...
  h1_ch03_EB_Mc       -> SetTitle();
  h1_neu03_EB_Mc      -> SetTitle();
  h1_ph03_EB_Mc       -> SetTitle();
  ...
  h1_ch03_EB_Data       -> SetTitle();
  h1_neu03_EB_Data      -> SetTitle();
  h1_ph03_EB_Data       -> SetTitle();
  ...
  h1_ch03_EE_Mc       -> SetTitle();
  h1_neu03_EE_Mc      -> SetTitle();
  h1_ph03_EE_Mc       -> SetTitle();
  ...
  h1_ch03_EE_Data       -> SetTitle();
  h1_neu03_EE_Data      -> SetTitle();
  h1_ph03_EE_Data       -> SetTitle();
  ...
  h1_ch03_EB_Mc        -> SetFillColor(kBlue-9);
  h1_neu03_EB_Mc       -> SetFillColor(kBlue-9);
  h1_ph03_EB_Mc        -> SetFillColor(kBlue-9); 
  ...
  h1_ch03_EB_Data        -> SetMarkerStyle(20);
  h1_neu03_EB_Data       -> SetMarkerStyle(20);
  h1_ph03_EB_Data        -> SetMarkerStyle(20); 
  ...
  h1_ch03_EE_Mc        -> SetFillColor(kBlue-9);
  h1_neu03_EE_Mc       -> SetFillColor(kBlue-9);
  h1_ph03_EE_Mc        -> SetFillColor(kBlue-9); 
  ...
  h1_ch03_EE_Data        -> SetMarkerStyle(20);
  h1_neu03_EE_Data       -> SetMarkerStyle(20);
  h1_ph03_EE_Data        -> SetMarkerStyle(20); 
  ...
  h1_ch03_EB_Mc   ->DrawNormalized("hist");
  h1_ch03_EB_Data ->DrawNormalized("sameEp");
  leg->Draw();
  myCB.SaveAs("h1_ch03_EB.png");
  myCB.SaveAs("h1_ch03_EB.root");

  h1_neu03_EB_Mc   ->DrawNormalized("hist");
  h1_neu03_EB_Data ->DrawNormalized("sameEp");
  leg->Draw();
  myCB.SaveAs("h1_neu03_EB.png");
  myCB.SaveAs("h1_neu03_EB.root");

  h1_ph03_EB_Mc   ->DrawNormalized("hist");
  h1_ph03_EB_Data ->DrawNormalized("sameEp");
  leg->Draw();
  myCB.SaveAs("h1_ph03_EB.png");
  myCB.SaveAs("h1_ph03_EB.root");
  ...
  h1_ch03_EE_Mc   ->DrawNormalized("hist");
  h1_ch03_EE_Data ->DrawNormalized("sameEp");
  leg->Draw();
  myCE.SaveAs("h1_ch03_EE.png");
  myCE.SaveAs("h1_ch03_EE.root");

  h1_neu03_EE_Mc   ->DrawNormalized("hist");
  h1_neu03_EE_Data ->DrawNormalized("sameEp");
  leg->Draw();
  myCE.SaveAs("h1_neu03_EE.png");
  myCE.SaveAs("h1_neu03_EE.root");

  h1_ph03_EE_Mc   ->DrawNormalized("hist");
  h1_ph03_EE_Data ->DrawNormalized("sameEp");
  leg->Draw();
  myCE.SaveAs("h1_ph03_EE.png");
  myCE.SaveAs("h1_ph03_EE.root");
