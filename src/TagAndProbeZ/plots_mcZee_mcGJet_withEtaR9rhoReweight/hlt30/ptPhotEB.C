...
//=========  (Fri Dec  5 12:49:10 2014) by ROOT version5.32/00
   ...
   ptPhot_mc_Z_EB__7->SetBinContent(5,0.8146985);
   ptPhot_mc_Z_EB__7->SetBinContent(6,0.1588687);
   ptPhot_mc_Z_EB__7->SetBinContent(7,0.0264329);
   ptPhot_mc_Z_EB__7->SetBinError(5,0.001204628);
   ptPhot_mc_Z_EB__7->SetBinError(6,0.000532911);
   ptPhot_mc_Z_EB__7->SetBinError(7,0.0002179182);
   ptPhot_mc_Z_EB__7->SetEntries(607274);
   ...
   ptPhot_mc_Z_EB__9->SetBinContent(5,0.8146985);
   ptPhot_mc_Z_EB__9->SetBinContent(6,0.1588687);
   ptPhot_mc_Z_EB__9->SetBinContent(7,0.0264329);
   ptPhot_mc_Z_EB__9->SetBinError(5,0.001204628);
   ptPhot_mc_Z_EB__9->SetBinError(6,0.000532911);
   ptPhot_mc_Z_EB__9->SetBinError(7,0.0002179182);
   ptPhot_mc_Z_EB__9->SetMinimum(0);
   ptPhot_mc_Z_EB__9->SetMaximum(1.140578);
   ptPhot_mc_Z_EB__9->SetEntries(607274);
   ...
   TLegend *leg = new TLegend(0.94,2.342426e-310,8.394902e+194,1.5,NULL,"brNDC");
   leg->SetBorderSize(0);
   leg->SetTextFont(62);
