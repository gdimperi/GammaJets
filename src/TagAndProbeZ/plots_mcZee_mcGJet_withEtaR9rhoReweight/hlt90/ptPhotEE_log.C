...
//=========  (Wed Dec  3 10:37:43 2014) by ROOT version5.32/00
...
// ------------>Primitives in pad: pad1
   ...
   ptPhot_mc_Z_EE__4->SetBinContent(5,0.7876272);
   ptPhot_mc_Z_EE__4->SetBinContent(6,0.1795945);
   ptPhot_mc_Z_EE__4->SetBinContent(7,0.03277823);
   ptPhot_mc_Z_EE__4->SetBinError(5,0.004775959);
   ptPhot_mc_Z_EE__4->SetBinError(6,0.00223909);
   ptPhot_mc_Z_EE__4->SetBinError(7,0.0009693846);
   ptPhot_mc_Z_EE__4->SetMinimum(3.316773e-07);
   ptPhot_mc_Z_EE__4->SetMaximum(4.410713);
   ptPhot_mc_Z_EE__4->SetEntries(458246);
   ...
   ptPhot_mc_Signal_EE__5->SetBinContent(11,0.2093824);
   ptPhot_mc_Signal_EE__5->SetBinContent(12,0.2932647);
   ptPhot_mc_Signal_EE__5->SetBinContent(13,0.1925695);
   ptPhot_mc_Signal_EE__5->SetBinContent(14,0.129059);
   ptPhot_mc_Signal_EE__5->SetBinContent(15,0.0886263);
   ptPhot_mc_Signal_EE__5->SetBinContent(16,0.06340198);
   ptPhot_mc_Signal_EE__5->SetBinContent(17,0.02369619);
   ptPhot_mc_Signal_EE__5->SetBinError(11,0.003815298);
   ptPhot_mc_Signal_EE__5->SetBinError(12,0.003204256);
   ptPhot_mc_Signal_EE__5->SetBinError(13,0.001632886);
   ptPhot_mc_Signal_EE__5->SetBinError(14,0.001222157);
   ptPhot_mc_Signal_EE__5->SetBinError(15,0.0009089924);
   ptPhot_mc_Signal_EE__5->SetBinError(16,0.0007200558);
   ptPhot_mc_Signal_EE__5->SetBinError(17,0.0003512933);
   ...
   ptPhot_mc_Z_EE__6->SetBinContent(5,0.7876272);
   ptPhot_mc_Z_EE__6->SetBinContent(6,0.1795945);
   ptPhot_mc_Z_EE__6->SetBinContent(7,0.03277823);
   ptPhot_mc_Z_EE__6->SetBinError(5,0.004775959);
   ptPhot_mc_Z_EE__6->SetBinError(6,0.00223909);
   ptPhot_mc_Z_EE__6->SetBinError(7,0.0009693846);
   ptPhot_mc_Z_EE__6->SetMinimum(3.316773e-07);
   ptPhot_mc_Z_EE__6->SetMaximum(4.410713);
   ptPhot_mc_Z_EE__6->SetEntries(458246);
   ...
   TLegend *leg = new TLegend(0,1.184667e-312,4.022956e-315,4.022957e-315,NULL,"brNDC");
   leg->SetBorderSize(0);
   leg->SetTextFont(62);
