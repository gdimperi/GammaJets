...
//=========  (Wed Dec  3 10:37:46 2014) by ROOT version5.32/00
   ...
   ptPhot->Range(-97.49999,-0.1037667,652.5,0.9339004);
...
// ------------>Primitives in pad: pad1
   ...
   ptPhot_mc_Z_EB__10->SetBinContent(5,0.7991079);
   ptPhot_mc_Z_EB__10->SetBinContent(6,0.1708078);
   ptPhot_mc_Z_EB__10->SetBinContent(7,0.03008427);
   ptPhot_mc_Z_EB__10->SetBinError(5,0.001378147);
   ptPhot_mc_Z_EB__10->SetBinError(6,0.000645752);
   ptPhot_mc_Z_EB__10->SetBinError(7,0.0002755766);
   ptPhot_mc_Z_EB__10->SetMinimum(1.20942e-07);
   ptPhot_mc_Z_EB__10->SetMaximum(4.475004);
   ptPhot_mc_Z_EB__10->SetEntries(1114625);
   ...
   ptPhot_mc_Signal_EB__11->SetBinContent(11,0.1950852);
   ptPhot_mc_Signal_EB__11->SetBinContent(12,0.2895032);
   ptPhot_mc_Signal_EB__11->SetBinContent(13,0.1925641);
   ptPhot_mc_Signal_EB__11->SetBinContent(14,0.1340163);
   ptPhot_mc_Signal_EB__11->SetBinContent(15,0.09401725);
   ptPhot_mc_Signal_EB__11->SetBinContent(16,0.06740388);
   ptPhot_mc_Signal_EB__11->SetBinContent(17,0.02740998);
   ptPhot_mc_Signal_EB__11->SetBinError(11,0.001882952);
   ptPhot_mc_Signal_EB__11->SetBinError(12,0.00178964);
   ptPhot_mc_Signal_EB__11->SetBinError(13,0.001118956);
   ptPhot_mc_Signal_EB__11->SetBinError(14,0.0008651942);
   ptPhot_mc_Signal_EB__11->SetBinError(15,0.0006318099);
   ptPhot_mc_Signal_EB__11->SetBinError(16,0.0004551154);
   ptPhot_mc_Signal_EB__11->SetBinError(17,0.0003133008);
   ...
   ptPhot_mc_Z_EB__12->SetBinContent(5,0.7991079);
   ptPhot_mc_Z_EB__12->SetBinContent(6,0.1708078);
   ptPhot_mc_Z_EB__12->SetBinContent(7,0.03008427);
   ptPhot_mc_Z_EB__12->SetBinError(5,0.001378147);
   ptPhot_mc_Z_EB__12->SetBinError(6,0.000645752);
   ptPhot_mc_Z_EB__12->SetBinError(7,0.0002755766);
   ptPhot_mc_Z_EB__12->SetMinimum(1.20942e-07);
   ptPhot_mc_Z_EB__12->SetMaximum(4.475004);
   ptPhot_mc_Z_EB__12->SetEntries(1114625);
   ...
   TLegend *leg = new TLegend(1.842513e-33,3.52517e+246,1.108819e+200,1.198901e-81,NULL,"brNDC");
   leg->SetBorderSize(0);
   leg->SetTextFont(62);
