...
//=========  (Sat Nov 29 19:43:44 2014) by ROOT version5.32/00
...
// ------------>Primitives in pad: pad1
   ...
   ptPhot_mc_Z_EE__4->SetBinContent(9,0.3638921);
   ptPhot_mc_Z_EE__4->SetBinContent(10,0.265906);
   ptPhot_mc_Z_EE__4->SetBinContent(11,0.1779626);
   ptPhot_mc_Z_EE__4->SetBinContent(12,0.1153918);
   ptPhot_mc_Z_EE__4->SetBinContent(13,0.07684749);
   ptPhot_mc_Z_EE__4->SetBinError(9,0.005612062);
   ptPhot_mc_Z_EE__4->SetBinError(10,0.004818991);
   ptPhot_mc_Z_EE__4->SetBinError(11,0.004982468);
   ptPhot_mc_Z_EE__4->SetBinError(12,0.005033751);
   ptPhot_mc_Z_EE__4->SetBinError(13,0.004775472);
   ptPhot_mc_Z_EE__4->SetMinimum(8.212428e-07);
   ptPhot_mc_Z_EE__4->SetMaximum(2.037796);
   ...
   ptPhot_mc_Z_EE__6->SetBinContent(9,0.3638921);
   ptPhot_mc_Z_EE__6->SetBinContent(10,0.265906);
   ptPhot_mc_Z_EE__6->SetBinContent(11,0.1779626);
   ptPhot_mc_Z_EE__6->SetBinContent(12,0.1153918);
   ptPhot_mc_Z_EE__6->SetBinContent(13,0.07684749);
   ptPhot_mc_Z_EE__6->SetBinError(9,0.005612062);
   ptPhot_mc_Z_EE__6->SetBinError(10,0.004818991);
   ptPhot_mc_Z_EE__6->SetBinError(11,0.004982468);
   ptPhot_mc_Z_EE__6->SetBinError(12,0.005033751);
   ptPhot_mc_Z_EE__6->SetBinError(13,0.004775472);
   ptPhot_mc_Z_EE__6->SetMinimum(8.212428e-07);
   ptPhot_mc_Z_EE__6->SetMaximum(2.037796);
