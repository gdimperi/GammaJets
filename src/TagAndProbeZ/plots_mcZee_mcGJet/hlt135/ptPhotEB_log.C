...
//=========  (Sat Nov 29 19:43:45 2014) by ROOT version5.32/00
   ...
   ptPhot->Range(-48.75,-0.05307642,326.25,0.4776878);
...
// ------------>Primitives in pad: pad1
   ...
   ptPhot_mc_Z_EB__10->SetBinContent(9,0.4067225);
   ptPhot_mc_Z_EB__10->SetBinContent(10,0.2571507);
   ptPhot_mc_Z_EB__10->SetBinContent(11,0.161006);
   ptPhot_mc_Z_EB__10->SetBinContent(12,0.1031919);
   ptPhot_mc_Z_EB__10->SetBinContent(13,0.07192893);
   ptPhot_mc_Z_EB__10->SetBinError(9,0.002724144);
   ptPhot_mc_Z_EB__10->SetBinError(10,0.002181151);
   ptPhot_mc_Z_EB__10->SetBinError(11,0.002197539);
   ptPhot_mc_Z_EB__10->SetBinError(12,0.002130726);
   ptPhot_mc_Z_EB__10->SetBinError(13,0.001955607);
   ptPhot_mc_Z_EB__10->SetMinimum(4.439851e-07);
   ptPhot_mc_Z_EB__10->SetMaximum(2.277646);
   ...
   ptPhot_mc_Signal_EB__11->SetBinContent(34,0.382375);
   ptPhot_mc_Signal_EB__11->SetBinContent(35,0.3327744);
   ptPhot_mc_Signal_EB__11->SetBinContent(36,0.2848506);
   ptPhot_mc_Signal_EB__11->SetBinError(34,0.004340197);
   ptPhot_mc_Signal_EB__11->SetBinError(35,0.003718354);
   ptPhot_mc_Signal_EB__11->SetBinError(36,0.002862006);
   ptPhot_mc_Signal_EB__11->SetEntries(237110);
   ...
   ptPhot_mc_Z_EB__12->SetBinContent(9,0.4067225);
   ptPhot_mc_Z_EB__12->SetBinContent(10,0.2571507);
   ptPhot_mc_Z_EB__12->SetBinContent(11,0.161006);
   ptPhot_mc_Z_EB__12->SetBinContent(12,0.1031919);
   ptPhot_mc_Z_EB__12->SetBinContent(13,0.07192893);
   ptPhot_mc_Z_EB__12->SetBinError(9,0.002724144);
   ptPhot_mc_Z_EB__12->SetBinError(10,0.002181151);
   ptPhot_mc_Z_EB__12->SetBinError(11,0.002197539);
   ptPhot_mc_Z_EB__12->SetBinError(12,0.002130726);
   ptPhot_mc_Z_EB__12->SetBinError(13,0.001955607);
   ptPhot_mc_Z_EB__12->SetMinimum(4.439851e-07);
   ptPhot_mc_Z_EB__12->SetMaximum(2.277646);
   ...
   TLegend *leg = new TLegend(1.679047e-307,6.01347e-154,6.01347e-154,6.01347e-154,NULL,"brNDC");
   leg->SetBorderSize(0);
   leg->SetTextFont(62);
