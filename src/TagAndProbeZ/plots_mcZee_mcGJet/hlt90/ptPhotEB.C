...
//=========  (Sat Nov 29 19:52:18 2014) by ROOT version5.32/00
   ...
   ptPhot_mc_Z_EB__7->SetBinContent(9,0.4065769);
   ptPhot_mc_Z_EB__7->SetBinContent(10,0.257206);
   ptPhot_mc_Z_EB__7->SetBinContent(11,0.1612295);
   ptPhot_mc_Z_EB__7->SetBinContent(12,0.1030772);
   ptPhot_mc_Z_EB__7->SetBinContent(13,0.07191042);
   ptPhot_mc_Z_EB__7->SetBinError(9,0.002728125);
   ptPhot_mc_Z_EB__7->SetBinError(10,0.002187539);
   ptPhot_mc_Z_EB__7->SetBinError(11,0.002205788);
   ptPhot_mc_Z_EB__7->SetBinError(12,0.002128885);
   ptPhot_mc_Z_EB__7->SetBinError(13,0.001958682);
   ...
   ptPhot_mc_Z_EB__9->SetBinContent(9,0.4065769);
   ptPhot_mc_Z_EB__9->SetBinContent(10,0.257206);
   ptPhot_mc_Z_EB__9->SetBinContent(11,0.1612295);
   ptPhot_mc_Z_EB__9->SetBinContent(12,0.1030772);
   ptPhot_mc_Z_EB__9->SetBinContent(13,0.07191042);
   ptPhot_mc_Z_EB__9->SetBinError(9,0.002728125);
   ptPhot_mc_Z_EB__9->SetBinError(10,0.002187539);
   ptPhot_mc_Z_EB__9->SetBinError(11,0.002205788);
   ptPhot_mc_Z_EB__9->SetBinError(12,0.002128885);
   ptPhot_mc_Z_EB__9->SetBinError(13,0.001958682);
   ptPhot_mc_Z_EB__9->SetMinimum(0);
   ptPhot_mc_Z_EB__9->SetMaximum(0.5692077);
