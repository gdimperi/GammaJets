...
//=========  (Sat Nov 29 18:21:10 2014) by ROOT version5.32/00
   ...
   ptPhot->Range(-48.75,-0.04784857,326.25,0.4306371);
...
// ------------>Primitives in pad: pad1
   ...
   ptPhot_mc_Z_EE__4->SetBinContent(9,0.3634875);
   ptPhot_mc_Z_EE__4->SetBinContent(10,0.2660252);
   ptPhot_mc_Z_EE__4->SetBinContent(11,0.1782188);
   ptPhot_mc_Z_EE__4->SetBinContent(12,0.1154016);
   ptPhot_mc_Z_EE__4->SetBinContent(13,0.07686686);
   ptPhot_mc_Z_EE__4->SetBinError(9,0.005629944);
   ptPhot_mc_Z_EE__4->SetBinError(10,0.004825318);
   ptPhot_mc_Z_EE__4->SetBinError(11,0.004992274);
   ptPhot_mc_Z_EE__4->SetBinError(12,0.005072928);
   ptPhot_mc_Z_EE__4->SetBinError(13,0.004796614);
   ptPhot_mc_Z_EE__4->SetMinimum(8.257641e-07);
   ptPhot_mc_Z_EE__4->SetMaximum(2.03553);
   ...
   ptPhot_mc_Z_EE__6->SetBinContent(9,0.3634875);
   ptPhot_mc_Z_EE__6->SetBinContent(10,0.2660252);
   ptPhot_mc_Z_EE__6->SetBinContent(11,0.1782188);
   ptPhot_mc_Z_EE__6->SetBinContent(12,0.1154016);
   ptPhot_mc_Z_EE__6->SetBinContent(13,0.07686686);
   ptPhot_mc_Z_EE__6->SetBinError(9,0.005629944);
   ptPhot_mc_Z_EE__6->SetBinError(10,0.004825318);
   ptPhot_mc_Z_EE__6->SetBinError(11,0.004992274);
   ptPhot_mc_Z_EE__6->SetBinError(12,0.005072928);
   ptPhot_mc_Z_EE__6->SetBinError(13,0.004796614);
   ptPhot_mc_Z_EE__6->SetMinimum(8.257641e-07);
   ptPhot_mc_Z_EE__6->SetMaximum(2.03553);
...
// ------------>Primitives in pad: pad2
   ...
   ratio->SetBinContent(9,0.9213029);
   ratio->SetBinContent(10,1.063351);
   ratio->SetBinContent(11,1.086164);
   ratio->SetBinContent(12,1.026616);
   ratio->SetBinContent(13,0.975508);
   ratio->SetBinError(9,0.01607018);
   ratio->SetBinError(10,0.02161608);
   ratio->SetBinError(11,0.0323864);
   ratio->SetBinError(12,0.04656275);
   ratio->SetBinError(13,0.06201505);
   ratio->SetMinimum(0.2);
   ratio->SetMaximum(3);
   ratio->SetEntries(3304.265);
   ratio->SetStats(0);
