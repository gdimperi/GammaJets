...
//=========  (Sat Nov 29 18:21:12 2014) by ROOT version5.32/00
   ...
   ptPhot_mc_Z_EB__7->SetBinContent(9,0.4064561);
   ptPhot_mc_Z_EB__7->SetBinContent(10,0.257264);
   ptPhot_mc_Z_EB__7->SetBinContent(11,0.1612808);
   ptPhot_mc_Z_EB__7->SetBinContent(12,0.1031116);
   ptPhot_mc_Z_EB__7->SetBinContent(13,0.07188756);
   ptPhot_mc_Z_EB__7->SetBinError(9,0.002733192);
   ptPhot_mc_Z_EB__7->SetBinError(10,0.002192541);
   ptPhot_mc_Z_EB__7->SetBinError(11,0.002210954);
   ptPhot_mc_Z_EB__7->SetBinError(12,0.002135318);
   ptPhot_mc_Z_EB__7->SetBinError(13,0.001960994);
   ...
   ptPhot_mc_Z_EB__9->SetBinContent(9,0.4064561);
   ptPhot_mc_Z_EB__9->SetBinContent(10,0.257264);
   ptPhot_mc_Z_EB__9->SetBinContent(11,0.1612808);
   ptPhot_mc_Z_EB__9->SetBinContent(12,0.1031116);
   ptPhot_mc_Z_EB__9->SetBinContent(13,0.07188756);
   ptPhot_mc_Z_EB__9->SetBinError(9,0.002733192);
   ptPhot_mc_Z_EB__9->SetBinError(10,0.002192541);
   ptPhot_mc_Z_EB__9->SetBinError(11,0.002210954);
   ptPhot_mc_Z_EB__9->SetBinError(12,0.002135318);
   ptPhot_mc_Z_EB__9->SetBinError(13,0.001960994);
   ptPhot_mc_Z_EB__9->SetMinimum(0);
   ptPhot_mc_Z_EB__9->SetMaximum(0.5690385);
