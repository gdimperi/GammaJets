...
//=========  (Sat Nov 29 18:21:09 2014) by ROOT version5.32/00
   ...
   ptPhot_mc_Z_EE__1->SetBinContent(9,0.3634875);
   ptPhot_mc_Z_EE__1->SetBinContent(10,0.2660252);
   ptPhot_mc_Z_EE__1->SetBinContent(11,0.1782188);
   ptPhot_mc_Z_EE__1->SetBinContent(12,0.1154016);
   ptPhot_mc_Z_EE__1->SetBinContent(13,0.07686686);
   ptPhot_mc_Z_EE__1->SetBinError(9,0.005629944);
   ptPhot_mc_Z_EE__1->SetBinError(10,0.004825318);
   ptPhot_mc_Z_EE__1->SetBinError(11,0.004992274);
   ptPhot_mc_Z_EE__1->SetBinError(12,0.005072928);
   ptPhot_mc_Z_EE__1->SetBinError(13,0.004796614);
   ...
   ptPhot_mc_Z_EE__3->SetBinContent(9,0.3634875);
   ptPhot_mc_Z_EE__3->SetBinContent(10,0.2660252);
   ptPhot_mc_Z_EE__3->SetBinContent(11,0.1782188);
   ptPhot_mc_Z_EE__3->SetBinContent(12,0.1154016);
   ptPhot_mc_Z_EE__3->SetBinContent(13,0.07686686);
   ptPhot_mc_Z_EE__3->SetBinError(9,0.005629944);
   ptPhot_mc_Z_EE__3->SetBinError(10,0.004825318);
   ptPhot_mc_Z_EE__3->SetBinError(11,0.004992274);
   ptPhot_mc_Z_EE__3->SetBinError(12,0.005072928);
   ptPhot_mc_Z_EE__3->SetBinError(13,0.004796614);
   ptPhot_mc_Z_EE__3->SetMinimum(0);
   ptPhot_mc_Z_EE__3->SetMaximum(0.5088825);
   ...
   TLegend *leg = new TLegend(2.538604e-315,1.184667e-312,0,0,NULL,"brNDC");
   leg->SetBorderSize(0);
   leg->SetTextFont(62);
