...
//=========  (Sat Nov 29 18:21:12 2014) by ROOT version5.32/00
   ...
   ptPhot->Range(-48.75,-0.05304305,326.25,0.4773875);
...
// ------------>Primitives in pad: pad1
   ...
   ptPhot_mc_Z_EB__10->SetBinContent(9,0.4064561);
   ptPhot_mc_Z_EB__10->SetBinContent(10,0.257264);
   ptPhot_mc_Z_EB__10->SetBinContent(11,0.1612808);
   ptPhot_mc_Z_EB__10->SetBinContent(12,0.1031116);
   ptPhot_mc_Z_EB__10->SetBinContent(13,0.07188756);
   ptPhot_mc_Z_EB__10->SetBinError(9,0.002733192);
   ptPhot_mc_Z_EB__10->SetBinError(10,0.002192541);
   ptPhot_mc_Z_EB__10->SetBinError(11,0.002210954);
   ptPhot_mc_Z_EB__10->SetBinError(12,0.002135318);
   ptPhot_mc_Z_EB__10->SetBinError(13,0.001960994);
   ptPhot_mc_Z_EB__10->SetMinimum(4.46368e-07);
   ptPhot_mc_Z_EB__10->SetMaximum(2.276154);
   ...
   ptPhot_mc_Z_EB__12->SetBinContent(9,0.4064561);
   ptPhot_mc_Z_EB__12->SetBinContent(10,0.257264);
   ptPhot_mc_Z_EB__12->SetBinContent(11,0.1612808);
   ptPhot_mc_Z_EB__12->SetBinContent(12,0.1031116);
   ptPhot_mc_Z_EB__12->SetBinContent(13,0.07188756);
   ptPhot_mc_Z_EB__12->SetBinError(9,0.002733192);
   ptPhot_mc_Z_EB__12->SetBinError(10,0.002192541);
   ptPhot_mc_Z_EB__12->SetBinError(11,0.002210954);
   ptPhot_mc_Z_EB__12->SetBinError(12,0.002135318);
   ptPhot_mc_Z_EB__12->SetBinError(13,0.001960994);
   ptPhot_mc_Z_EB__12->SetMinimum(4.46368e-07);
   ptPhot_mc_Z_EB__12->SetMaximum(2.276154);
...
// ------------>Primitives in pad: pad2
   ...
   ratio->SetBinContent(9,1.025819);
   ratio->SetBinContent(10,1.018388);
   ratio->SetBinContent(11,0.978033);
   ratio->SetBinContent(12,0.9393717);
   ratio->SetBinContent(13,0.9398856);
   ratio->SetBinError(9,0.00924003);
   ratio->SetBinError(10,0.01119209);
   ratio->SetBinError(11,0.01544214);
   ratio->SetBinError(12,0.02102386);
   ratio->SetBinError(13,0.02712941);
   ratio->SetMinimum(0.2);
   ratio->SetMaximum(3);
   ratio->SetEntries(14765.26);
   ratio->SetStats(0);
