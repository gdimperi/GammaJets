...
//=========  (Sun Sep 28 10:31:45 2014) by ROOT version5.32/00
   ...
   ptPhot->Range(-48.75,-0.05951213,326.25,0.5356091);
   ...
   ptPhot_mc_Z_All__7->SetBinContent(9,0.5004101);
   ptPhot_mc_Z_All__7->SetBinContent(10,0.3094496);
   ptPhot_mc_Z_All__7->SetBinContent(11,0.1136343);
   ptPhot_mc_Z_All__7->SetBinContent(12,0.05005552);
   ptPhot_mc_Z_All__7->SetBinContent(13,0.02645049);
   ptPhot_mc_Z_All__7->SetBinError(9,0.0005745502);
   ptPhot_mc_Z_All__7->SetBinError(10,0.0004511255);
   ptPhot_mc_Z_All__7->SetBinError(11,0.0002733522);
   ptPhot_mc_Z_All__7->SetBinError(12,0.0001819048);
   ptPhot_mc_Z_All__7->SetBinError(13,0.0001324276);
   ...
   ptPhot_mc_Z_All__9->SetBinContent(9,0.5004101);
   ptPhot_mc_Z_All__9->SetBinContent(10,0.3094496);
   ptPhot_mc_Z_All__9->SetBinContent(11,0.1136343);
   ptPhot_mc_Z_All__9->SetBinContent(12,0.05005552);
   ptPhot_mc_Z_All__9->SetBinContent(13,0.02645049);
   ptPhot_mc_Z_All__9->SetBinError(9,0.0005745502);
   ptPhot_mc_Z_All__9->SetBinError(10,0.0004511255);
   ptPhot_mc_Z_All__9->SetBinError(11,0.0002733522);
   ptPhot_mc_Z_All__9->SetBinError(12,0.0001819048);
   ptPhot_mc_Z_All__9->SetBinError(13,0.0001324276);
   ptPhot_mc_Z_All__9->SetMinimum(0);
   ptPhot_mc_Z_All__9->SetMaximum(0.7005741);
   ...
   TLegend *leg = new TLegend(1.067364e-311,0,3.258529e-315,3.264584e-315,NULL,"brNDC");
   leg->SetBorderSize(0);
   leg->SetTextFont(62);
