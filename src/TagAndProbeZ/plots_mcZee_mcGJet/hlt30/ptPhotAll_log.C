...
//=========  (Sun Sep 28 10:31:45 2014) by ROOT version5.32/00
   ...
   ptPhot->Range(-48.75,-0.06494246,326.25,0.5844821);
...
// ------------>Primitives in pad: pad1
   ...
   ptPhot_mc_Z_All__10->SetBinContent(9,0.5004101);
   ptPhot_mc_Z_All__10->SetBinContent(10,0.3094496);
   ptPhot_mc_Z_All__10->SetBinContent(11,0.1136343);
   ptPhot_mc_Z_All__10->SetBinContent(12,0.05005552);
   ptPhot_mc_Z_All__10->SetBinContent(13,0.02645049);
   ptPhot_mc_Z_All__10->SetBinError(9,0.0005745502);
   ptPhot_mc_Z_All__10->SetBinError(10,0.0004511255);
   ptPhot_mc_Z_All__10->SetBinError(11,0.0002733522);
   ptPhot_mc_Z_All__10->SetBinError(12,0.0001819048);
   ptPhot_mc_Z_All__10->SetBinError(13,0.0001324276);
   ptPhot_mc_Z_All__10->SetMinimum(5.959851e-08);
   ptPhot_mc_Z_All__10->SetMaximum(2.802297);
   ...
   ptPhot_mc_Z_All__12->SetBinContent(9,0.5004101);
   ptPhot_mc_Z_All__12->SetBinContent(10,0.3094496);
   ptPhot_mc_Z_All__12->SetBinContent(11,0.1136343);
   ptPhot_mc_Z_All__12->SetBinContent(12,0.05005552);
   ptPhot_mc_Z_All__12->SetBinContent(13,0.02645049);
   ptPhot_mc_Z_All__12->SetBinError(9,0.0005745502);
   ptPhot_mc_Z_All__12->SetBinError(10,0.0004511255);
   ptPhot_mc_Z_All__12->SetBinError(11,0.0002733522);
   ptPhot_mc_Z_All__12->SetBinError(12,0.0001819048);
   ptPhot_mc_Z_All__12->SetBinError(13,0.0001324276);
   ptPhot_mc_Z_All__12->SetMinimum(5.959851e-08);
   ptPhot_mc_Z_All__12->SetMaximum(2.802297);
   ...
   TLegend *leg = new TLegend(1.58101e-322,9.535467e-322,3.258981e-315,1.184667e-312,NULL,"brNDC");
   leg->SetBorderSize(0);
   leg->SetTextFont(62);
...
// ------------>Primitives in pad: pad2
   ...
   ratio->SetBinContent(9,1.213557);
   ratio->SetBinContent(10,1.229613);
   ratio->SetBinContent(11,0.7104994);
   ratio->SetBinContent(12,0.4806416);
   ratio->SetBinContent(13,0.3678441);
   ratio->SetBinError(9,0.005363571);
   ratio->SetBinError(10,0.006437186);
   ratio->SetBinError(11,0.004444882);
   ratio->SetBinError(12,0.003519037);
   ratio->SetBinError(13,0.00320935);
   ratio->SetMinimum(0.2);
   ratio->SetMaximum(3);
   ratio->SetEntries(142191.2);
   ratio->SetStats(0);
