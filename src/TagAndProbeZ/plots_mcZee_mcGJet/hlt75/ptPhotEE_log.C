...
// ------------>Primitives in pad: pad1
   ...
   ptPhot_mc_Z_EE__4->SetBinContent(9,0.3635978);
   ptPhot_mc_Z_EE__4->SetBinContent(10,0.2659973);
   ptPhot_mc_Z_EE__4->SetBinContent(11,0.1781951);
   ptPhot_mc_Z_EE__4->SetBinContent(12,0.1152952);
   ptPhot_mc_Z_EE__4->SetBinContent(13,0.07691453);
   ptPhot_mc_Z_EE__4->SetBinError(9,0.00563033);
   ptPhot_mc_Z_EE__4->SetBinError(10,0.004815064);
   ptPhot_mc_Z_EE__4->SetBinError(11,0.0049793);
   ptPhot_mc_Z_EE__4->SetBinError(12,0.00505916);
   ptPhot_mc_Z_EE__4->SetBinError(13,0.004786755);
   ptPhot_mc_Z_EE__4->SetMinimum(8.248374e-07);
   ptPhot_mc_Z_EE__4->SetMaximum(2.036148);
   ...
   ptPhot_mc_Signal_EE__5->SetBinContent(19,0.4159811);
   ptPhot_mc_Signal_EE__5->SetBinContent(20,0.329556);
   ptPhot_mc_Signal_EE__5->SetBinContent(21,0.2544629);
   ptPhot_mc_Signal_EE__5->SetBinError(19,0.005109133);
   ptPhot_mc_Signal_EE__5->SetBinError(20,0.005508416);
   ptPhot_mc_Signal_EE__5->SetBinError(21,0.003386735);
   ptPhot_mc_Signal_EE__5->SetEntries(175626);
   ...
   ptPhot_mc_Z_EE__6->SetBinContent(9,0.3635978);
   ptPhot_mc_Z_EE__6->SetBinContent(10,0.2659973);
   ptPhot_mc_Z_EE__6->SetBinContent(11,0.1781951);
   ptPhot_mc_Z_EE__6->SetBinContent(12,0.1152952);
   ptPhot_mc_Z_EE__6->SetBinContent(13,0.07691453);
   ptPhot_mc_Z_EE__6->SetBinError(9,0.00563033);
   ptPhot_mc_Z_EE__6->SetBinError(10,0.004815064);
   ptPhot_mc_Z_EE__6->SetBinError(11,0.0049793);
   ptPhot_mc_Z_EE__6->SetBinError(12,0.00505916);
   ptPhot_mc_Z_EE__6->SetBinError(13,0.004786755);
   ptPhot_mc_Z_EE__6->SetMinimum(8.248374e-07);
   ptPhot_mc_Z_EE__6->SetMaximum(2.036148);
