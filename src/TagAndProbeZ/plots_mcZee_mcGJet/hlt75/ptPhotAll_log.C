...
//=========  (Thu Sep 18 00:09:54 2014) by ROOT version5.32/00
   ...
   ptPhot->Range(-48.75,-0.05539948,326.25,0.4985953);
...
// ------------>Primitives in pad: pad1
   ...
   ptPhot_mc_Z_All__10->SetBinContent(19,0.420655);
   ptPhot_mc_Z_All__10->SetBinContent(20,0.3262072);
   ptPhot_mc_Z_All__10->SetBinContent(21,0.2531378);
   ptPhot_mc_Z_All__10->SetBinError(19,0.006712409);
   ptPhot_mc_Z_All__10->SetBinError(20,0.005909546);
   ptPhot_mc_Z_All__10->SetBinError(21,0.005215698);
   ptPhot_mc_Z_All__10->SetMinimum(9.64282e-06);
   ptPhot_mc_Z_All__10->SetMaximum(2.355668);
   ptPhot_mc_Z_All__10->SetEntries(9745);
   ...
   ptPhot_mc_Signal_All__11->SetBinContent(19,0.4223463);
   ptPhot_mc_Signal_All__11->SetBinContent(20,0.3233351);
   ptPhot_mc_Signal_All__11->SetBinContent(21,0.2543185);
   ptPhot_mc_Signal_All__11->SetBinError(19,0.003928382);
   ptPhot_mc_Signal_All__11->SetBinError(20,0.002720807);
   ptPhot_mc_Signal_All__11->SetBinError(21,0.002390586);
   ptPhot_mc_Signal_All__11->SetEntries(522413);
   ...
   ptPhot_mc_Z_All__12->SetBinContent(19,0.420655);
   ptPhot_mc_Z_All__12->SetBinContent(20,0.3262072);
   ptPhot_mc_Z_All__12->SetBinContent(21,0.2531378);
   ptPhot_mc_Z_All__12->SetBinError(19,0.006712409);
   ptPhot_mc_Z_All__12->SetBinError(20,0.005909546);
   ptPhot_mc_Z_All__12->SetBinError(21,0.005215698);
   ptPhot_mc_Z_All__12->SetMinimum(9.64282e-06);
   ptPhot_mc_Z_All__12->SetMaximum(2.355668);
   ptPhot_mc_Z_All__12->SetEntries(9745);
   ...
   TLegend *leg = new TLegend(0,3.237909e-316,9745,0.9999992,NULL,"brNDC");
   leg->SetBorderSize(0);
   leg->SetTextFont(62);
...
// ------------>Primitives in pad: pad2
   ...
   ratio->SetBinContent(19,0.9959953);
   ratio->SetBinContent(20,1.008883);
   ratio->SetBinContent(21,0.9953573);
   ratio->SetBinError(19,0.01839606);
   ratio->SetBinError(20,0.02015231);
   ratio->SetBinError(21,0.02254197);
   ratio->SetMinimum(0.2);
   ratio->SetMaximum(3);
   ratio->SetEntries(7185.773);
   ratio->SetStats(0);
