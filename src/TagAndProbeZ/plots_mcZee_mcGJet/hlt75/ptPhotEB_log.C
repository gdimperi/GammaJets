...
//=========  (Sat Nov 29 19:51:35 2014) by ROOT version5.32/00
   ...
   ptPhot->Range(-48.75,-0.0530489,326.25,0.4774401);
...
// ------------>Primitives in pad: pad1
   ...
   ptPhot_mc_Z_EB__10->SetBinContent(9,0.4064995);
   ptPhot_mc_Z_EB__10->SetBinContent(10,0.2572539);
   ptPhot_mc_Z_EB__10->SetBinContent(11,0.1611707);
   ptPhot_mc_Z_EB__10->SetBinContent(12,0.1031418);
   ptPhot_mc_Z_EB__10->SetBinContent(13,0.07193409);
   ptPhot_mc_Z_EB__10->SetBinError(9,0.002734792);
   ptPhot_mc_Z_EB__10->SetBinError(10,0.002191717);
   ptPhot_mc_Z_EB__10->SetBinError(11,0.002208652);
   ptPhot_mc_Z_EB__10->SetBinError(12,0.002135327);
   ptPhot_mc_Z_EB__10->SetBinError(13,0.00196208);
   ptPhot_mc_Z_EB__10->SetMinimum(4.456885e-07);
   ptPhot_mc_Z_EB__10->SetMaximum(2.276397);
   ...
   ptPhot_mc_Z_EB__12->SetBinContent(9,0.4064995);
   ptPhot_mc_Z_EB__12->SetBinContent(10,0.2572539);
   ptPhot_mc_Z_EB__12->SetBinContent(11,0.1611707);
   ptPhot_mc_Z_EB__12->SetBinContent(12,0.1031418);
   ptPhot_mc_Z_EB__12->SetBinContent(13,0.07193409);
   ptPhot_mc_Z_EB__12->SetBinError(9,0.002734792);
   ptPhot_mc_Z_EB__12->SetBinError(10,0.002191717);
   ptPhot_mc_Z_EB__12->SetBinError(11,0.002208652);
   ptPhot_mc_Z_EB__12->SetBinError(12,0.002135327);
   ptPhot_mc_Z_EB__12->SetBinError(13,0.00196208);
   ptPhot_mc_Z_EB__12->SetMinimum(4.456885e-07);
   ptPhot_mc_Z_EB__12->SetMaximum(2.276397);
