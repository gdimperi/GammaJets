...
//=========  (Sun Sep 28 11:59:19 2014) by ROOT version5.32/00
   ...
   ptPhot->Range(-48.75,-0.05998583,326.25,0.5398725);
...
// ------------>Primitives in pad: pad1
   ...
   ptPhot_mc_Z_EE__4->SetBinContent(9,0.4605855);
   ptPhot_mc_Z_EE__4->SetBinContent(10,0.3187363);
   ptPhot_mc_Z_EE__4->SetBinContent(11,0.1278509);
   ptPhot_mc_Z_EE__4->SetBinContent(12,0.05925579);
   ptPhot_mc_Z_EE__4->SetBinContent(13,0.0335715);
   ptPhot_mc_Z_EE__4->SetBinError(9,0.002162324);
   ptPhot_mc_Z_EE__4->SetBinError(10,0.001762078);
   ptPhot_mc_Z_EE__4->SetBinError(11,0.00112287);
   ptPhot_mc_Z_EE__4->SetBinError(12,0.0007677918);
   ptPhot_mc_Z_EE__4->SetBinError(13,0.0006150315);
   ptPhot_mc_Z_EE__4->SetMinimum(1.010644e-07);
   ptPhot_mc_Z_EE__4->SetMaximum(2.579279);
   ptPhot_mc_Z_EE__4->SetEntries(258604);
   ...
   ptPhot_mc_Z_EE__6->SetBinContent(9,0.4605855);
   ptPhot_mc_Z_EE__6->SetBinContent(10,0.3187363);
   ptPhot_mc_Z_EE__6->SetBinContent(11,0.1278509);
   ptPhot_mc_Z_EE__6->SetBinContent(12,0.05925579);
   ptPhot_mc_Z_EE__6->SetBinContent(13,0.0335715);
   ptPhot_mc_Z_EE__6->SetBinError(9,0.002162324);
   ptPhot_mc_Z_EE__6->SetBinError(10,0.001762078);
   ptPhot_mc_Z_EE__6->SetBinError(11,0.00112287);
   ptPhot_mc_Z_EE__6->SetBinError(12,0.0007677918);
   ptPhot_mc_Z_EE__6->SetBinError(13,0.0006150315);
   ptPhot_mc_Z_EE__6->SetMinimum(1.010644e-07);
   ptPhot_mc_Z_EE__6->SetMaximum(2.579279);
   ptPhot_mc_Z_EE__6->SetEntries(258604);
   ...
   TLegend *leg = new TLegend(1.184667e-312,1.184667e-312,1.897212e-321,1.027657e-321,NULL,"brNDC");
   leg->SetBorderSize(0);
   leg->SetTextFont(62);
...
// ------------>Primitives in pad: pad2
   ...
   ratio->SetBinContent(9,1.167409);
   ratio->SetBinContent(10,1.274047);
   ratio->SetBinContent(11,0.7791939);
   ratio->SetBinContent(12,0.5271413);
   ratio->SetBinContent(13,0.4260518);
   ratio->SetBinError(9,0.01085097);
   ratio->SetBinError(10,0.01365032);
   ratio->SetBinError(11,0.01049825);
   ratio->SetBinError(12,0.009017525);
   ratio->SetBinError(13,0.009364161);
   ratio->SetMinimum(0.2);
   ratio->SetMaximum(3);
   ratio->SetEntries(29866.68);
   ratio->SetStats(0);
