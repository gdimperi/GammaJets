...
//=========  (Sun Sep 28 11:59:19 2014) by ROOT version5.32/00
   ...
   ptPhot_mc_Z_EE__1->SetBinContent(9,0.4605855);
   ptPhot_mc_Z_EE__1->SetBinContent(10,0.3187363);
   ptPhot_mc_Z_EE__1->SetBinContent(11,0.1278509);
   ptPhot_mc_Z_EE__1->SetBinContent(12,0.05925579);
   ptPhot_mc_Z_EE__1->SetBinContent(13,0.0335715);
   ptPhot_mc_Z_EE__1->SetBinError(9,0.002162324);
   ptPhot_mc_Z_EE__1->SetBinError(10,0.001762078);
   ptPhot_mc_Z_EE__1->SetBinError(11,0.00112287);
   ptPhot_mc_Z_EE__1->SetBinError(12,0.0007677918);
   ptPhot_mc_Z_EE__1->SetBinError(13,0.0006150315);
   ptPhot_mc_Z_EE__1->SetEntries(258604);
   ...
   ptPhot_mc_Z_EE__3->SetBinContent(9,0.4605855);
   ptPhot_mc_Z_EE__3->SetBinContent(10,0.3187363);
   ptPhot_mc_Z_EE__3->SetBinContent(11,0.1278509);
   ptPhot_mc_Z_EE__3->SetBinContent(12,0.05925579);
   ptPhot_mc_Z_EE__3->SetBinContent(13,0.0335715);
   ptPhot_mc_Z_EE__3->SetBinError(9,0.002162324);
   ptPhot_mc_Z_EE__3->SetBinError(10,0.001762078);
   ptPhot_mc_Z_EE__3->SetBinError(11,0.00112287);
   ptPhot_mc_Z_EE__3->SetBinError(12,0.0007677918);
   ptPhot_mc_Z_EE__3->SetBinError(13,0.0006150315);
   ptPhot_mc_Z_EE__3->SetMinimum(0);
   ptPhot_mc_Z_EE__3->SetMaximum(0.6448197);
   ptPhot_mc_Z_EE__3->SetEntries(258604);
   ...
   TLegend *leg = new TLegend(0,4.940656e-324,4.031576e-321,2.371515e-322,NULL,"brNDC");
   leg->SetBorderSize(0);
   leg->SetTextFont(62);
