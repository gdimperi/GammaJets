...
//=========  (Sun Sep 28 11:59:21 2014) by ROOT version5.32/00
   ...
   ptPhot_mc_Z_All__7->SetBinContent(9,0.502863);
   ptPhot_mc_Z_All__7->SetBinContent(10,0.3082578);
   ptPhot_mc_Z_All__7->SetBinContent(11,0.113044);
   ptPhot_mc_Z_All__7->SetBinContent(12,0.04962875);
   ptPhot_mc_Z_All__7->SetBinContent(13,0.02620645);
   ptPhot_mc_Z_All__7->SetBinError(9,0.0006064284);
   ptPhot_mc_Z_All__7->SetBinError(10,0.0004711962);
   ptPhot_mc_Z_All__7->SetBinError(11,0.0002855016);
   ptPhot_mc_Z_All__7->SetBinError(12,0.0001893489);
   ptPhot_mc_Z_All__7->SetBinError(13,0.0001378618);
   ptPhot_mc_Z_All__7->SetEntries(1581075);
   ...
   ptPhot_mc_Z_All__9->SetBinContent(9,0.502863);
   ptPhot_mc_Z_All__9->SetBinContent(10,0.3082578);
   ptPhot_mc_Z_All__9->SetBinContent(11,0.113044);
   ptPhot_mc_Z_All__9->SetBinContent(12,0.04962875);
   ptPhot_mc_Z_All__9->SetBinContent(13,0.02620645);
   ptPhot_mc_Z_All__9->SetBinError(9,0.0006064284);
   ptPhot_mc_Z_All__9->SetBinError(10,0.0004711962);
   ptPhot_mc_Z_All__9->SetBinError(11,0.0002855016);
   ptPhot_mc_Z_All__9->SetBinError(12,0.0001893489);
   ptPhot_mc_Z_All__9->SetBinError(13,0.0001378618);
   ptPhot_mc_Z_All__9->SetMinimum(0);
   ptPhot_mc_Z_All__9->SetMaximum(0.7040083);
   ptPhot_mc_Z_All__9->SetEntries(1581075);
