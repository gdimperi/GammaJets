...
//=========  (Sun Sep 28 11:59:23 2014) by ROOT version5.32/00
   ...
   ptPhot_mc_Z_EB__13->SetBinContent(9,0.5017707);
   ptPhot_mc_Z_EB__13->SetBinContent(10,0.3044989);
   ptPhot_mc_Z_EB__13->SetBinContent(11,0.1132259);
   ptPhot_mc_Z_EB__13->SetBinContent(12,0.05186997);
   ptPhot_mc_Z_EB__13->SetBinContent(13,0.02863457);
   ptPhot_mc_Z_EB__13->SetBinError(9,0.001030834);
   ptPhot_mc_Z_EB__13->SetBinError(10,0.000793692);
   ptPhot_mc_Z_EB__13->SetBinError(11,0.0004819795);
   ptPhot_mc_Z_EB__13->SetBinError(12,0.0003239546);
   ptPhot_mc_Z_EB__13->SetBinError(13,0.0002411519);
   ...
   ptPhot_mc_Z_EB__15->SetBinContent(9,0.5017707);
   ptPhot_mc_Z_EB__15->SetBinContent(10,0.3044989);
   ptPhot_mc_Z_EB__15->SetBinContent(11,0.1132259);
   ptPhot_mc_Z_EB__15->SetBinContent(12,0.05186997);
   ptPhot_mc_Z_EB__15->SetBinContent(13,0.02863457);
   ptPhot_mc_Z_EB__15->SetBinError(9,0.001030834);
   ptPhot_mc_Z_EB__15->SetBinError(10,0.000793692);
   ptPhot_mc_Z_EB__15->SetBinError(11,0.0004819795);
   ptPhot_mc_Z_EB__15->SetBinError(12,0.0003239546);
   ptPhot_mc_Z_EB__15->SetBinError(13,0.0002411519);
   ptPhot_mc_Z_EB__15->SetMinimum(0);
   ptPhot_mc_Z_EB__15->SetMaximum(0.702479);
   ...
   TLegend *leg = new TLegend(2.346891e-310,0,0,2.346891e-310,NULL,"brNDC");
   leg->SetBorderSize(0);
   leg->SetTextFont(62);
