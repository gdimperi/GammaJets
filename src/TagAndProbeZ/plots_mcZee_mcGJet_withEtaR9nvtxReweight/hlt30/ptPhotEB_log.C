...
//=========  (Sun Sep 28 11:59:23 2014) by ROOT version5.32/00
   ...
   ptPhot->Range(-48.75,-0.06517798,326.25,0.5866018);
...
// ------------>Primitives in pad: pad1
   ...
   ptPhot_mc_Z_EB__16->SetBinContent(9,0.5017707);
   ptPhot_mc_Z_EB__16->SetBinContent(10,0.3044989);
   ptPhot_mc_Z_EB__16->SetBinContent(11,0.1132259);
   ptPhot_mc_Z_EB__16->SetBinContent(12,0.05186997);
   ptPhot_mc_Z_EB__16->SetBinContent(13,0.02863457);
   ptPhot_mc_Z_EB__16->SetBinError(9,0.001030834);
   ptPhot_mc_Z_EB__16->SetBinError(10,0.000793692);
   ptPhot_mc_Z_EB__16->SetBinError(11,0.0004819795);
   ptPhot_mc_Z_EB__16->SetBinError(12,0.0003239546);
   ptPhot_mc_Z_EB__16->SetBinError(13,0.0002411519);
   ptPhot_mc_Z_EB__16->SetMinimum(4.740358e-08);
   ptPhot_mc_Z_EB__16->SetMaximum(2.809916);
   ...
   ptPhot_mc_Z_EB__18->SetBinContent(9,0.5017707);
   ptPhot_mc_Z_EB__18->SetBinContent(10,0.3044989);
   ptPhot_mc_Z_EB__18->SetBinContent(11,0.1132259);
   ptPhot_mc_Z_EB__18->SetBinContent(12,0.05186997);
   ptPhot_mc_Z_EB__18->SetBinContent(13,0.02863457);
   ptPhot_mc_Z_EB__18->SetBinError(9,0.001030834);
   ptPhot_mc_Z_EB__18->SetBinError(10,0.000793692);
   ptPhot_mc_Z_EB__18->SetBinError(11,0.0004819795);
   ptPhot_mc_Z_EB__18->SetBinError(12,0.0003239546);
   ptPhot_mc_Z_EB__18->SetBinError(13,0.0002411519);
   ptPhot_mc_Z_EB__18->SetMinimum(4.740358e-08);
   ptPhot_mc_Z_EB__18->SetMaximum(2.809916);
...
// ------------>Primitives in pad: pad2
   ...
   ratio->SetBinContent(9,1.266375);
   ratio->SetBinContent(10,1.205369);
   ratio->SetBinContent(11,0.6866202);
   ratio->SetBinContent(12,0.4725479);
   ratio->SetBinContent(13,0.3743794);
   ratio->SetBinError(9,0.008022944);
   ratio->SetBinError(10,0.008934437);
   ratio->SetBinError(11,0.006121439);
   ratio->SetBinError(12,0.004979736);
   ratio->SetBinError(13,0.004735068);
   ratio->SetMinimum(0.2);
   ratio->SetMaximum(3);
   ratio->SetEntries(70089.96);
   ratio->SetStats(0);
