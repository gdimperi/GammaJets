...
//=========  (Sun Sep 28 15:21:25 2014) by ROOT version5.32/00
   ...
   ptPhot_mc_Z_All__7->SetBinContent(22,0.1956541);
   ptPhot_mc_Z_All__7->SetBinContent(23,0.1477901);
   ptPhot_mc_Z_All__7->SetBinContent(24,0.1284936);
   ptPhot_mc_Z_All__7->SetBinContent(25,0.09928229);
   ptPhot_mc_Z_All__7->SetBinContent(26,0.08479707);
   ptPhot_mc_Z_All__7->SetBinContent(27,0.07619454);
   ptPhot_mc_Z_All__7->SetBinContent(28,0.06486019);
   ptPhot_mc_Z_All__7->SetBinContent(29,0.0557859);
   ptPhot_mc_Z_All__7->SetBinContent(30,0.04702262);
   ptPhot_mc_Z_All__7->SetBinContent(31,0.03835697);
   ptPhot_mc_Z_All__7->SetBinContent(32,0.03329247);
   ptPhot_mc_Z_All__7->SetBinContent(33,0.02847017);
   ptPhot_mc_Z_All__7->SetBinError(22,0.004673851);
   ptPhot_mc_Z_All__7->SetBinError(23,0.004070106);
   ptPhot_mc_Z_All__7->SetBinError(24,0.003786777);
   ptPhot_mc_Z_All__7->SetBinError(25,0.003335302);
   ptPhot_mc_Z_All__7->SetBinError(26,0.003097803);
   ptPhot_mc_Z_All__7->SetBinError(27,0.002937308);
   ptPhot_mc_Z_All__7->SetBinError(28,0.002719503);
   ptPhot_mc_Z_All__7->SetBinError(29,0.00249293);
   ptPhot_mc_Z_All__7->SetBinError(30,0.002317424);
   ptPhot_mc_Z_All__7->SetBinError(31,0.002101856);
   ptPhot_mc_Z_All__7->SetBinError(32,0.001945295);
   ptPhot_mc_Z_All__7->SetBinError(33,0.00181359);
   ...
   ptPhot_mc_Z_All__9->SetBinContent(22,0.1956541);
   ptPhot_mc_Z_All__9->SetBinContent(23,0.1477901);
   ptPhot_mc_Z_All__9->SetBinContent(24,0.1284936);
   ptPhot_mc_Z_All__9->SetBinContent(25,0.09928229);
   ptPhot_mc_Z_All__9->SetBinContent(26,0.08479707);
   ptPhot_mc_Z_All__9->SetBinContent(27,0.07619454);
   ptPhot_mc_Z_All__9->SetBinContent(28,0.06486019);
   ptPhot_mc_Z_All__9->SetBinContent(29,0.0557859);
   ptPhot_mc_Z_All__9->SetBinContent(30,0.04702262);
   ptPhot_mc_Z_All__9->SetBinContent(31,0.03835697);
   ptPhot_mc_Z_All__9->SetBinContent(32,0.03329247);
   ptPhot_mc_Z_All__9->SetBinContent(33,0.02847017);
   ptPhot_mc_Z_All__9->SetBinError(22,0.004673851);
   ptPhot_mc_Z_All__9->SetBinError(23,0.004070106);
   ptPhot_mc_Z_All__9->SetBinError(24,0.003786777);
   ptPhot_mc_Z_All__9->SetBinError(25,0.003335302);
   ptPhot_mc_Z_All__9->SetBinError(26,0.003097803);
   ptPhot_mc_Z_All__9->SetBinError(27,0.002937308);
   ptPhot_mc_Z_All__9->SetBinError(28,0.002719503);
   ptPhot_mc_Z_All__9->SetBinError(29,0.00249293);
   ptPhot_mc_Z_All__9->SetBinError(30,0.002317424);
   ptPhot_mc_Z_All__9->SetBinError(31,0.002101856);
   ptPhot_mc_Z_All__9->SetBinError(32,0.001945295);
   ptPhot_mc_Z_All__9->SetBinError(33,0.00181359);
   ptPhot_mc_Z_All__9->SetMinimum(0);
   ptPhot_mc_Z_All__9->SetMaximum(0.2739158);
