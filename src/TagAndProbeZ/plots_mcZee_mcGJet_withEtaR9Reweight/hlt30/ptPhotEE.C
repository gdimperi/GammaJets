...
//=========  (Sat Sep 27 23:43:14 2014) by ROOT version5.32/00
   ...
   ptPhot_mc_Z_EE__1->SetBinContent(9,0.4636329);
   ptPhot_mc_Z_EE__1->SetBinContent(10,0.3162068);
   ptPhot_mc_Z_EE__1->SetBinContent(11,0.1271584);
   ptPhot_mc_Z_EE__1->SetBinContent(12,0.05941559);
   ptPhot_mc_Z_EE__1->SetBinContent(13,0.03358636);
   ptPhot_mc_Z_EE__1->SetBinError(9,0.002216612);
   ptPhot_mc_Z_EE__1->SetBinError(10,0.001793613);
   ptPhot_mc_Z_EE__1->SetBinError(11,0.001148521);
   ptPhot_mc_Z_EE__1->SetBinError(12,0.0007897222);
   ptPhot_mc_Z_EE__1->SetBinError(13,0.0006240085);
   ptPhot_mc_Z_EE__1->SetEntries(258605);
   ...
   ptPhot_mc_Z_EE__3->SetBinContent(9,0.4636329);
   ptPhot_mc_Z_EE__3->SetBinContent(10,0.3162068);
   ptPhot_mc_Z_EE__3->SetBinContent(11,0.1271584);
   ptPhot_mc_Z_EE__3->SetBinContent(12,0.05941559);
   ptPhot_mc_Z_EE__3->SetBinContent(13,0.03358636);
   ptPhot_mc_Z_EE__3->SetBinError(9,0.002216612);
   ptPhot_mc_Z_EE__3->SetBinError(10,0.001793613);
   ptPhot_mc_Z_EE__3->SetBinError(11,0.001148521);
   ptPhot_mc_Z_EE__3->SetBinError(12,0.0007897222);
   ptPhot_mc_Z_EE__3->SetBinError(13,0.0006240085);
   ptPhot_mc_Z_EE__3->SetMinimum(0);
   ptPhot_mc_Z_EE__3->SetMaximum(0.649086);
   ptPhot_mc_Z_EE__3->SetEntries(258605);
   ...
   TLegend *leg = new TLegend(0,-7.689685e+40,4.031576e-321,2.371515e-322,NULL,"brNDC");
   leg->SetBorderSize(0);
   leg->SetTextFont(62);
