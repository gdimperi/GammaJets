...
//=========  (Sat Sep 27 23:43:17 2014) by ROOT version5.32/00
   ...
   ptPhot_mc_Z_EB__13->SetBinContent(9,0.5011016);
   ptPhot_mc_Z_EB__13->SetBinContent(10,0.3040583);
   ptPhot_mc_Z_EB__13->SetBinContent(11,0.1134866);
   ptPhot_mc_Z_EB__13->SetBinContent(12,0.05233064);
   ptPhot_mc_Z_EB__13->SetBinContent(13,0.02902289);
   ptPhot_mc_Z_EB__13->SetBinError(9,0.001042106);
   ptPhot_mc_Z_EB__13->SetBinError(10,0.0008029104);
   ptPhot_mc_Z_EB__13->SetBinError(11,0.000490001);
   ptPhot_mc_Z_EB__13->SetBinError(12,0.000331626);
   ptPhot_mc_Z_EB__13->SetBinError(13,0.0002476634);
   ptPhot_mc_Z_EB__13->SetEntries(787055);
   ...
   ptPhot_mc_Z_EB__15->SetBinContent(9,0.5011016);
   ptPhot_mc_Z_EB__15->SetBinContent(10,0.3040583);
   ptPhot_mc_Z_EB__15->SetBinContent(11,0.1134866);
   ptPhot_mc_Z_EB__15->SetBinContent(12,0.05233064);
   ptPhot_mc_Z_EB__15->SetBinContent(13,0.02902289);
   ptPhot_mc_Z_EB__15->SetBinError(9,0.001042106);
   ptPhot_mc_Z_EB__15->SetBinError(10,0.0008029104);
   ptPhot_mc_Z_EB__15->SetBinError(11,0.000490001);
   ptPhot_mc_Z_EB__15->SetBinError(12,0.000331626);
   ptPhot_mc_Z_EB__15->SetBinError(13,0.0002476634);
   ptPhot_mc_Z_EB__15->SetMinimum(0);
   ptPhot_mc_Z_EB__15->SetMaximum(0.7015423);
   ptPhot_mc_Z_EB__15->SetEntries(787055);
   ...
   TLegend *leg = new TLegend(1.067364e-311,0,3.767241e-315,3.767096e-315,NULL,"brNDC");
   leg->SetBorderSize(0);
   leg->SetTextFont(62);
