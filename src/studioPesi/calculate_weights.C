...
void calculate_weights(int hltCut){
  ...
  std::string outputDir = "histo_v6/genIso4/isoWeight/tightPresel2/weights_rebin/";
  ...
  mc.Project("combPfIso03Phot_matched_passMVA_EB"	  	,"combinedPfIso03Phot",("(isIsolatedGenPhot && "+passMVA_EB+" && "+pt+")*weight").c_str());
  mc.Project("combPfIso03Phot_matched_notPassMVA_EB"	  	,"combinedPfIso03Phot",("(isIsolatedGenPhot && "+notPassMVA_EB+" && "+pt+")*weight").c_str());
  mc.Project("combPfIso03Phot_matched_passMVA_EE"	  	,"combinedPfIso03Phot",("(isIsolatedGenPhot && "+passMVA_EE+" && "+pt+")*weight").c_str());
  mc.Project("combPfIso03Phot_matched_notPassMVA_EE"	  	,"combinedPfIso03Phot",("(isIsolatedGenPhot && "+notPassMVA_EE+" && "+pt+")*weight").c_str());
              						  
  mc.Project("combPfIso03Phot_notMatched_passMVA_EB"	  	,"combinedPfIso03Phot",("(!isIsolatedGenPhot && "+passMVA_EB+" && "+pt+")*weight").c_str());
  mc.Project("combPfIso03Phot_notMatched_notPassMVA_EB"	        ,"combinedPfIso03Phot",("(!isIsolatedGenPhot && "+notPassMVA_EB+" && "+pt+")*weight").c_str());
  mc.Project("combPfIso03Phot_notMatched_passMVA_EE"	  	,"combinedPfIso03Phot",("(!isIsolatedGenPhot && "+passMVA_EE+" && "+pt+")*weight").c_str());
  mc.Project("combPfIso03Phot_notMatched_notPassMVA_EE"	        ,"combinedPfIso03Phot",("(!isIsolatedGenPhot && "+notPassMVA_EE+" && "+pt+")*weight").c_str());
  
  data.Project("combPfIso03Phot_data_passMVA_EB"   		,"combinedPfIso03Phot",("("+passMVA_EB+" && "+pt+")*weight").c_str());
  data.Project("combPfIso03Phot_data_notPassMVA_EB"		,"combinedPfIso03Phot",("("+notPassMVA_EB+" && "+pt+")*weight").c_str());
  data.Project("combPfIso03Phot_data_passMVA_EE"   		,"combinedPfIso03Phot",("("+passMVA_EE+" && "+pt+")*weight").c_str());
  data.Project("combPfIso03Phot_data_notPassMVA_EE"		,"combinedPfIso03Phot",("("+notPassMVA_EE+" && "+pt+")*weight").c_str());
  ...
  */
  ...
  TH1F* h_isoWeight_EB = (TH1F*)combPfIso03Phot_notMatched_passMVA_EB	->Clone("h_isoWeight_EB");
  h_isoWeight_EB							->Divide(combPfIso03Phot_notMatched_notPassMVA_EB);
  TH1F* h_isoWeight_EE = (TH1F*)combPfIso03Phot_notMatched_passMVA_EE	->Clone("h_isoWeight_EE");
  h_isoWeight_EE							->Divide(combPfIso03Phot_notMatched_notPassMVA_EE);

  //w1 and w2 (for systematics) 
  TH1F* h_syst_EB = (TH1F*)combPfIso03Phot_notMatched_notPassMVA_EB    	->Clone("h_syst_EB");
  h_syst_EB								->Divide(combPfIso03Phot_data_notPassMVA_EB);
  TH1F* h_syst_EE = (TH1F*)combPfIso03Phot_notMatched_notPassMVA_EE    	->Clone("h_syst_EE");
  ...
  */
  ...
  // weights histos
  h_isoWeight_EB	->GetXaxis()->SetTitle("combinedPfIso03");
  h_isoWeight_EE	->GetXaxis()->SetTitle("combinedPfIso03");
  ...
  h_isoWeight1_EB	->GetXaxis()->SetTitle("combinedPfIso03");
  h_isoWeight1_EE	->GetXaxis()->SetTitle("combinedPfIso03");
  h_isoWeight1_EB	->GetYaxis()->SetTitle("weight 2");
  h_isoWeight1_EE	->GetYaxis()->SetTitle("weight 2");
  ...
  */
  ...
  combPfIso03Phot_data_notPassMVA_EB->SetLineColor(6);
  combPfIso03Phot_data_passMVA_EB->SetLineColor(3);
  combPfIso03Phot_data_passMVA_EB->DrawNormalized("hist");
  combPfIso03Phot_data_notPassMVA_EB->DrawNormalized("histsame");
  leg2->Draw();
  ...
  combPfIso03Phot_data_notPassMVA_EE->SetLineColor(6);
  combPfIso03Phot_data_passMVA_EE->SetLineColor(3);
  combPfIso03Phot_data_passMVA_EE->DrawNormalized("hist");
  combPfIso03Phot_data_notPassMVA_EE->DrawNormalized("histsame");
  leg2->Draw();
