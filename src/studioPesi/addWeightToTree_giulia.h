...
addWeightToTree::addWeightToTree(TTree *tree) : fChain(0) 
{
  if (tree == 0) {
    ...
    //G+jets                                                                                                                            
    //chain->Add("/cmsrm/pc24/gdimperi/GammaJets/ridottissime_isoPF03_5/HLT30/G_Pt*root");
    //chain->Add("/cmsrm/pc24/gdimperi/GammaJets/ridottissime_isoPF03_5/HLT50/G_Pt*root");
    //chain->Add("/cmsrm/pc24/gdimperi/GammaJets/ridottissime_isoPF03_5/HLT75/G_Pt*root");
    //chain->Add("/cmsrm/pc24/gdimperi/GammaJets/ridottissime_isoPF03_5/HLT90/G_Pt*root");
    //chain->Add("/cmsrm/pc24/gdimperi/GammaJets/ridottissime_isoPF03_5/HLT135/G_Pt*root");
    //chain->Add("/cmsrm/pc24/gdimperi/GammaJets/ridottissime_isoPF03_5/HLT150/G_Pt*root");
...
void addWeightToTree::createBranches(TTree* treeWithWeights){
  ...
  treeWithWeights->Branch("isIsolatedGenPhot", &isIsolatedGenPhot, "isIsolatedGenPhot/I");
