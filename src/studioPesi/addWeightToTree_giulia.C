...
void addWeightToTree::Loop()
{
  ...
  TFile* fileWeights  = TFile::Open("histo_v6/genIso4/isoWeight/tightPresel3/isoWeights.root");
  string outputDir = "outputWithWeight_tightPresel3/";
  //  TFile* fileWeights  = TFile::Open("histo_v6/genIso4/isoWeight/preselIso5/isoWeights.root");
  //string outputDir = "outputWithWeight_preselIso5/";
  ...
  TFile* outFile=TFile::Open((outputDir+"gjTrees_withWeights.root").c_str(),"recreate");
  //TFile* outFile=TFile::Open((outputDir+"qcdTrees_withWeights.root").c_str(),"recreate");
  //TFile* outFile=TFile::Open((outputDir+"data2012ABCD_withWeights.root").c_str(),"recreate");
