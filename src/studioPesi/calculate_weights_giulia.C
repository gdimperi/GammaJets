...
void calculate_weights(){
  ...
  TChain mc("finalTree");
  //presel cut : isoPF<4
  //mc.Add("/cmsrm/pc24/gdimperi/GammaJets/ridottissime/HLT30/G_Pt*root");
  //mc.Add("/cmsrm/pc24/gdimperi/GammaJets/ridottissime/HLT50/G_Pt*root");
  //mc.Add("/cmsrm/pc24/gdimperi/GammaJets/ridottissime/HLT75/G_Pt*root");
  //mc.Add("/cmsrm/pc24/gdimperi/GammaJets/ridottissime/HLT90/G_Pt*root");
  //mc.Add("/cmsrm/pc24/gdimperi/GammaJets/ridottissime/HLT135/G_Pt*root");
  //mc.Add("/cmsrm/pc24/gdimperi/GammaJets/ridottissime/HLT150/G_Pt*root");
      
  //mc.Add("/cmsrm/pc24/gdimperi/GammaJets/ridottissime/HLT30/QCDEM*root");
  //mc.Add("/cmsrm/pc24/gdimperi/GammaJets/ridottissime/HLT50/QCDEM*root");
  //mc.Add("/cmsrm/pc24/gdimperi/GammaJets/ridottissime/HLT75/QCDEM*root");
  //mc.Add("/cmsrm/pc24/gdimperi/GammaJets/ridottissime/HLT90/QCDEM*root");
  //mc.Add("/cmsrm/pc24/gdimperi/GammaJets/ridottissime/HLT135/QCDEM*root");
  //mc.Add("/cmsrm/pc24/gdimperi/GammaJets/ridottissime/HLT150/QCDEM*root");
  ...
  //tight presel (mvacut 99%)
  //mc.Add("/cmsrm/pc24/gdimperi/GammaJets/ridottissime_tightPresel/HLT30/G_Pt*root");
  //mc.Add("/cmsrm/pc24/gdimperi/GammaJets/ridottissime_tightPresel/HLT50/G_Pt*root");
  //mc.Add("/cmsrm/pc24/gdimperi/GammaJets/ridottissime_tightPresel/HLT75/G_Pt*root");
  //mc.Add("/cmsrm/pc24/gdimperi/GammaJets/ridottissime_tightPresel/HLT90/G_Pt*root");
  //mc.Add("/cmsrm/pc24/gdimperi/GammaJets/ridottissime_tightPresel/HLT135/G_Pt*root");
  //mc.Add("/cmsrm/pc24/gdimperi/GammaJets/ridottissime_tightPresel/HLT150/G_Pt*root");

  //mc.Add("/cmsrm/pc24/gdimperi/GammaJets/ridottissime_tightPresel/HLT30/QCDEM*root");
  //mc.Add("/cmsrm/pc24/gdimperi/GammaJets/ridottissime_tightPresel/HLT50/QCDEM*root");
  //mc.Add("/cmsrm/pc24/gdimperi/GammaJets/ridottissime_tightPresel/HLT75/QCDEM*root");
  //mc.Add("/cmsrm/pc24/gdimperi/GammaJets/ridottissime_tightPresel/HLT90/QCDEM*root");
  //mc.Add("/cmsrm/pc24/gdimperi/GammaJets/ridottissime_tightPresel/HLT135/QCDEM*root");
  //mc.Add("/cmsrm/pc24/gdimperi/GammaJets/ridottissime_tightPresel/HLT150/QCDEM*root");


  // output
  std::string outputDir = "histo_v6/genIso4/isoWeight/tightPresel3/";
  ...
  notPassMVA_EB = "(weight>0 && weight<15000) && (TMath::Abs(etaPhot)<1.4442) && (mvaIdPhot>0. && mvaIdPhot<0.6)";			    
  passMVA_EE    = "(weight>0 && weight<15000) && (TMath::Abs(etaPhot)>1.479 && TMath::Abs(etaPhot)<2.5) && (mvaIdPhot<1. && mvaIdPhot>0.87382)"; 
  notPassMVA_EE = "(weight>0 && weight<15000) && (TMath::Abs(etaPhot)>1.479 && TMath::Abs(etaPhot)<2.5) && (mvaIdPhot>0 && mvaIdPhot<0.6)";

  // inclusive
  cout << "now projecting inclusive" << endl;
  mc.Project("combPfIsoFPR03Phot_notMatched_passMVA_EB",    "combinedPfIsoFPR03Phot", ("(!isIsolatedGenPhot && "+passMVA_EB+")*weight").c_str());
  mc.Project("combPfIsoFPR03Phot_notMatched_notPassMVA_EB", "combinedPfIsoFPR03Phot", ("(!isIsolatedGenPhot && "+notPassMVA_EB+")*weight").c_str());
  mc.Project("combPfIsoFPR03Phot_notMatched_passMVA_EE",    "combinedPfIsoFPR03Phot", ("(!isIsolatedGenPhot && "+passMVA_EE+")*weight").c_str());
  mc.Project("combPfIsoFPR03Phot_notMatched_notPassMVA_EE", "combinedPfIsoFPR03Phot", ("(!isIsolatedGenPhot && "+notPassMVA_EE+")*weight").c_str());

  cout << "now projecting inclusive signal gammas" << endl;
  mc.Project("combPfIsoFPR03Phot_matched_passMVA_EB",    "combinedPfIsoFPR03Phot", ("(isIsolatedGenPhot && "+passMVA_EB+")*weight").c_str());
  mc.Project("combPfIsoFPR03Phot_matched_notPassMVA_EB", "combinedPfIsoFPR03Phot", ("(isIsolatedGenPhot && "+notPassMVA_EB+")*weight").c_str());
  mc.Project("combPfIsoFPR03Phot_matched_passMVA_EE",    "combinedPfIsoFPR03Phot", ("(isIsolatedGenPhot && "+passMVA_EE+")*weight").c_str());
  mc.Project("combPfIsoFPR03Phot_matched_notPassMVA_EE", "combinedPfIsoFPR03Phot", ("(isIsolatedGenPhot && "+notPassMVA_EE+")*weight").c_str());
	   
  // pt40_65
  cout << "now projecting 40-65" << endl;
  std::string pt = "(ptPhot>40. && ptPhot<65.)"; 
  mc.Project("combPfIsoFPR03Phot_notMatched_passMVA_EB_pt40_65",   "combinedPfIsoFPR03Phot",("(!isIsolatedGenPhot && "+passMVA_EB+" && "+pt+")*weight").c_str());
  mc.Project("combPfIsoFPR03Phot_notMatched_notPassMVA_EB_pt40_65","combinedPfIsoFPR03Phot",("(!isIsolatedGenPhot && "+notPassMVA_EB+" && "+pt+")*weight").c_str());
  mc.Project("combPfIsoFPR03Phot_notMatched_passMVA_EE_pt40_65",   "combinedPfIsoFPR03Phot",("(!isIsolatedGenPhot && "+passMVA_EE+" && " +pt+")*weight").c_str());
  mc.Project("combPfIsoFPR03Phot_notMatched_notPassMVA_EE_pt40_65","combinedPfIsoFPR03Phot",("(!isIsolatedGenPhot && "+notPassMVA_EE+" && "+pt+")*weight").c_str());
	  
  //pt65_90
  cout << "now projecting 65-90" << endl;
  pt = "(ptPhot>65. && ptPhot<90.)"; 
  mc.Project("combPfIsoFPR03Phot_notMatched_passMVA_EB_pt65_90",   "combinedPfIsoFPR03Phot",("(!isIsolatedGenPhot && "+passMVA_EB+" && "+pt+")*weight").c_str());
  mc.Project("combPfIsoFPR03Phot_notMatched_notPassMVA_EB_pt65_90","combinedPfIsoFPR03Phot",("(!isIsolatedGenPhot && "+notPassMVA_EB+" && "+pt+")*weight").c_str());
  mc.Project("combPfIsoFPR03Phot_notMatched_passMVA_EE_pt65_90",   "combinedPfIsoFPR03Phot",("(!isIsolatedGenPhot && "+passMVA_EE+" && "+pt+")*weight").c_str());
  mc.Project("combPfIsoFPR03Phot_notMatched_notPassMVA_EE_pt65_90","combinedPfIsoFPR03Phot",("(!isIsolatedGenPhot && "+notPassMVA_EE+" && "+pt+")*weight").c_str());
	  
  //pt90_105
  cout << "now projecting 90-105" << endl;
  pt = "(ptPhot>90. && ptPhot<105.)"; 
  mc.Project("combPfIsoFPR03Phot_notMatched_passMVA_EB_pt90_105",   "combinedPfIsoFPR03Phot",("(!isIsolatedGenPhot && "+passMVA_EB+" && "+pt+")*weight").c_str());
  mc.Project("combPfIsoFPR03Phot_notMatched_notPassMVA_EB_pt90_105","combinedPfIsoFPR03Phot",("(!isIsolatedGenPhot && "+notPassMVA_EB+" && "+pt+")*weight").c_str());
  mc.Project("combPfIsoFPR03Phot_notMatched_passMVA_EE_pt90_105",   "combinedPfIsoFPR03Phot",("(!isIsolatedGenPhot && "+passMVA_EE+" && "+pt+")*weight").c_str());
  mc.Project("combPfIsoFPR03Phot_notMatched_notPassMVA_EE_pt90_105","combinedPfIsoFPR03Phot",("(!isIsolatedGenPhot && "+notPassMVA_EE+" && "+pt+")*weight").c_str());

  //pt105
  cout << "now projecting 105" << endl;
  pt = "(ptPhot>105.)"; 
  mc.Project("combPfIsoFPR03Phot_notMatched_passMVA_EB_pt105",   "combinedPfIsoFPR03Phot",("(!isIsolatedGenPhot && "+passMVA_EB+" && "+pt+")*weight").c_str());
  mc.Project("combPfIsoFPR03Phot_notMatched_notPassMVA_EB_pt105","combinedPfIsoFPR03Phot",("(!isIsolatedGenPhot && "+notPassMVA_EB+" && "+pt+")*weight").c_str());
  mc.Project("combPfIsoFPR03Phot_notMatched_passMVA_EE_pt105",   "combinedPfIsoFPR03Phot",("(!isIsolatedGenPhot && "+passMVA_EE+" && "+pt+")*weight").c_str());
  mc.Project("combPfIsoFPR03Phot_notMatched_notPassMVA_EE_pt105","combinedPfIsoFPR03Phot",("(!isIsolatedGenPhot && "+notPassMVA_EE+" && "+pt+")*weight").c_str());
  ...
  cout << " weights hlt90 + hl135 + hlt150" << endl;
