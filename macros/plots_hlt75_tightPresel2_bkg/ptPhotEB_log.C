...
//=========  (Tue Feb 18 12:51:35 2014) by ROOT version5.32/00
   ...
   ptPhot->Range(-162.5,-599.5803,1087.5,5396.222);
...
// ------------>Primitives in pad: pad1
   ...
   ptPhot_data_EB->SetMaximum(19426.4);
...
// ------------>Primitives in pad: pad2
   ...
   ratio->SetBinContent(6,1.296913);
   ratio->SetBinContent(7,1.163756);
   ratio->SetBinError(6,0.04919582);
   ratio->SetBinError(7,0.08704204);
   ratio->SetMinimum(0.2);
   ratio->SetMaximum(3);
   ratio->SetEntries(605.6985);
   ratio->SetStats(0);
