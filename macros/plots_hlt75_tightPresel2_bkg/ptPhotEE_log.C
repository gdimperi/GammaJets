...
// ------------>Primitives in pad: pad1
   ...
   ptPhot_data_EE->SetBinContent(6,4877);
   ptPhot_data_EE->SetBinContent(7,1637);
   ptPhot_data_EE->SetBinError(6,69.83552);
   ptPhot_data_EE->SetBinError(7,40.45986);
   ptPhot_data_EE->SetMinimum(0.1);
   ptPhot_data_EE->SetMaximum(27311.2);
   ptPhot_data_EE->SetEntries(6514);
   ...
   ptPhot_mc_Bkg_EE->SetBinContent(6,3244.37);
   ptPhot_mc_Bkg_EE->SetBinContent(7,933.2739);
   ptPhot_mc_Bkg_EE->SetBinError(6,118.3835);
   ptPhot_mc_Bkg_EE->SetBinError(7,50.28618);
   ptPhot_mc_Bkg_EE->SetEntries(7132);
   ...
   ptPhot_mc_Signal_EE->SetBinContent(6,93.94781);
   ptPhot_mc_Signal_EE->SetBinContent(7,53.48176);
   ptPhot_mc_Signal_EE->SetBinError(6,7.603236);
   ptPhot_mc_Signal_EE->SetBinError(7,22.58527);
   ptPhot_mc_Signal_EE->SetEntries(1021);
...
// ------------>Primitives in pad: pad2
   ...
   ratio->SetBinContent(6,1.460915);
   ratio->SetBinContent(7,1.658972);
   ratio->SetBinError(6,0.05597016);
   ratio->SetBinError(7,0.1013439);
   ratio->SetMinimum(0.2);
   ratio->SetMaximum(3);
   ratio->SetEntries(726.2193);
   ratio->SetStats(0);
