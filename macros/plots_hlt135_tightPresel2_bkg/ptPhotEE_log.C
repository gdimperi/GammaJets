...
// ------------>Primitives in pad: pad1
   ...
   ptPhot_data_EE->SetMaximum(77386.4);
   ...
   TLegend *leg = new TLegend(2.365747e-310,2.365747e-310,0,4.340367e-320,NULL,"brNDC");
   leg->SetBorderSize(0);
   leg->SetTextFont(62);
...
// ------------>Primitives in pad: pad2
   ...
   ratio->SetBinContent(10,2.170527);
   ratio->SetBinContent(11,2.154408);
   ratio->SetBinError(10,0.3015791);
   ratio->SetBinError(11,0.1273621);
   ratio->SetMinimum(0.2);
   ratio->SetMaximum(3);
   ratio->SetEntries(174.5346);
   ratio->SetStats(0);
