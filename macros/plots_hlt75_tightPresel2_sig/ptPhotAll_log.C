...
// ------------>Primitives in pad: pad1
   ...
   ptPhot_data_All->SetMaximum(299460);
...
// ------------>Primitives in pad: pad2
   ...
   ratio->SetBinContent(6,1.230526);
   ratio->SetBinContent(7,1.264649);
   ratio->SetBinError(6,0.01058646);
   ratio->SetBinError(7,0.01687888);
   ratio->SetMinimum(0.2);
   ratio->SetMaximum(3);
   ratio->SetEntries(15683.55);
   ratio->SetStats(0);
