...
//=========  (Tue Feb 18 12:59:46 2014) by ROOT version5.32/00
   ...
   ptPhot->Range(-162.5,-1957.062,1087.5,17613.56);
...
// ------------>Primitives in pad: pad1
   ...
   ptPhot_data_EE->SetMaximum(63408.8);
   ...
   TLegend *leg = new TLegend(1.797504e-152,1.107644e-47,1.398043e-76,1.397993e-76,NULL,"brNDC");
   leg->SetBorderSize(0);
   leg->SetTextFont(62);
...
// ------------>Primitives in pad: pad2
   ...
   ratio->SetBinContent(6,1.08116);
   ratio->SetBinContent(7,1.146383);
   ratio->SetBinError(6,0.01695238);
   ratio->SetBinError(7,0.02757118);
   ratio->SetMinimum(0.2);
   ratio->SetMaximum(3);
   ratio->SetEntries(4736.702);
   ratio->SetStats(0);
