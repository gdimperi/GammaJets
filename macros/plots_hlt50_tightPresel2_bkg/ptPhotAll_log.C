...
//=========  (Tue Feb 18 12:50:44 2014) by ROOT version5.32/00
...
// ------------>Primitives in pad: pad1
   ...
   ptPhot_data_All->SetMaximum(317368.8);
...
// ------------>Primitives in pad: pad2
   ...
   ratio->SetBinContent(4,1.157655);
   ratio->SetBinContent(5,1.189976);
   ratio->SetBinContent(6,1.182046);
   ratio->SetBinError(4,0.02016961);
   ratio->SetBinError(5,0.008108616);
   ratio->SetBinError(6,0.01599508);
   ratio->SetMinimum(0.2);
   ratio->SetMaximum(3);
   ratio->SetEntries(17103.97);
   ratio->SetStats(0);
