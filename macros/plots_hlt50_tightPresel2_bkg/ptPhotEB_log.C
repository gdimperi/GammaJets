...
//=========  (Tue Feb 18 12:50:45 2014) by ROOT version5.32/00
   ...
   ptPhot->Range(-162.5,-738.0248,1087.5,6642.222);
...
// ------------>Primitives in pad: pad1
   ...
   ptPhot_data_EB->SetMaximum(23912);
...
// ------------>Primitives in pad: pad2
   ...
   ratio->SetBinContent(4,1.232672);
   ratio->SetBinContent(5,1.118822);
   ratio->SetBinContent(6,1.165877);
   ratio->SetBinError(4,0.08357037);
   ratio->SetBinError(5,0.03030467);
   ratio->SetBinError(6,0.0660265);
   ratio->SetMinimum(0.2);
   ratio->SetMaximum(3);
   ratio->SetEntries(1008.973);
   ratio->SetStats(0);
