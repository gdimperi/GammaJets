...
//   data_phot.Add("/cmshome/gdimperi/GammaJet/GammaJetAnalysis/CMSSW_5_3_11/src/GammaJets/ridottissime/ridottissime_isoPF03_5/HLT150/SinglePhoton_*root");
  ...
  TFile* outputFile = new TFile("etaWeights.root", "recreate");

  outputFile->cd();

  //TH1F* h_target = new TH1F("h_target", "", 100, -3., 3.);
  TH1F* h_mc_phot = new TH1F("h_mc_phot", "", 100, -3., 3.);
  TH1F* h_mc_ele_EB = new TH1F("h_mc_ele_EB", "", 100, -3., 3.);
  TH1F* h_mc_ele_EE = new TH1F("h_mc_ele_EE", "", 100, -3., 3.);

  //data_phot.Project("h_target", "etaPhot");
  mc_phot.Project("h_mc_phot", "etaPhot");
  mc_ele.Project("h_mc_ele_EB", "probe_eta", "(TMath::Abs(probe_eta)<1.4442)*r9WeightEB");
  mc_ele.Project("h_mc_ele_EE", "probe_eta", "(TMath::Abs(probe_eta)>1.566)*r9WeightEE");
