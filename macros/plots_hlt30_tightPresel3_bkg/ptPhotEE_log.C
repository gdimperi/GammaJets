...
//=========  (Tue Feb 11 18:09:21 2014) by ROOT version5.32/00
   TCanvas *ptPhot = new TCanvas("ptPhot", "ptPhot",1,1,1000,876);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   ptPhot->SetHighLightColor(2);
   ptPhot->Range(-162.5,-757.0371,1087.5,6813.333);
...
// ------------>Primitives in pad: pad1
   ...
   ptPhot_data_EE->SetBinContent(3,4380);
   ptPhot_data_EE->SetBinContent(4,1784);
   ptPhot_data_EE->SetBinError(3,66.18157);
   ptPhot_data_EE->SetBinError(4,42.23742);
   ptPhot_data_EE->SetMinimum(0.1);
   ptPhot_data_EE->SetMaximum(24528);
   ptPhot_data_EE->SetEntries(6164);
   ...
   ptPhot_mc_Bkg_EE->SetBinContent(3,3970.083);
   ptPhot_mc_Bkg_EE->SetBinContent(4,1472.53);
   ptPhot_mc_Bkg_EE->SetBinError(3,41.02279);
   ptPhot_mc_Bkg_EE->SetBinError(4,24.38333);
   ptPhot_mc_Bkg_EE->SetEntries(35218);
   ...
   ptPhot_mc_Signal_EE->SetBinContent(3,295.5354);
   ptPhot_mc_Signal_EE->SetBinContent(4,79.72161);
   ptPhot_mc_Signal_EE->SetBinError(3,7.602591);
   ptPhot_mc_Signal_EE->SetBinError(4,3.644439);
   ptPhot_mc_Signal_EE->SetEntries(19036);
...
// ------------>Primitives in pad: pad2
   ...
   ratio->SetBinContent(3,1.026815);
   ratio->SetBinContent(4,1.149298);
   ratio->SetBinError(3,0.01848196);
   ratio->SetBinError(4,0.03276614);
   ratio->SetMinimum(0.2);
   ratio->SetMaximum(3);
   ratio->SetEntries(3346.14);
   ratio->SetStats(0);
