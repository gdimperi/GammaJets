...
//=========  (Tue Feb 18 13:00:34 2014) by ROOT version5.32/00
   ...
   ptPhot->Range(-162.5,-1756.05,1087.5,15804.44);
...
// ------------>Primitives in pad: pad1
   ...
   ptPhot_data_EE->SetMaximum(56896);
...
// ------------>Primitives in pad: pad2
   ...
   ratio->SetBinContent(4,1.056296);
   ratio->SetBinContent(5,1.05174);
   ratio->SetBinContent(6,1.048028);
   ratio->SetBinError(4,0.03947159);
   ratio->SetBinError(5,0.01490151);
   ratio->SetBinError(6,0.02905306);
   ratio->SetMinimum(0.2);
   ratio->SetMaximum(3);
   ratio->SetEntries(3795.808);
   ratio->SetStats(0);
