...
//=========  (Tue Feb 18 13:00:36 2014) by ROOT version5.32/00
   ...
   ptPhot->Range(-162.5,-2613.506,1087.5,23521.56);
...
// ------------>Primitives in pad: pad1
   ...
   ptPhot_data_EB->SetMaximum(84677.6);
...
// ------------>Primitives in pad: pad2
   ...
   ratio->SetBinContent(4,0.9739737);
   ratio->SetBinContent(5,1.082628);
   ratio->SetBinContent(6,1.10581);
   ratio->SetBinError(4,0.02893642);
   ratio->SetBinError(5,0.0122856);
   ratio->SetBinError(6,0.02439724);
   ratio->SetMinimum(0.2);
   ratio->SetMaximum(3);
   ratio->SetEntries(6315.748);
   ratio->SetStats(0);
