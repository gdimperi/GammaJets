...
// ------------>Primitives in pad: pad1
   ...
   ptPhot_data_EE->SetMaximum(44223.2);
   ...
   TLegend *leg = new TLegend(3.040853e-67,4.003916e+98,1.562023e+11,4.581039e-72,NULL,"brNDC");
   leg->SetBorderSize(0);
   leg->SetTextFont(62);
...
// ------------>Primitives in pad: pad2
   ...
   ratio->SetBinContent(19,1.390341);
   ratio->SetBinContent(20,1.624039);
   ratio->SetBinContent(21,1.583477);
   ratio->SetBinError(19,0.04106984);
   ratio->SetBinError(20,0.04549173);
   ratio->SetBinError(21,0.05256611);
   ratio->SetMinimum(0.2);
   ratio->SetMaximum(3);
   ratio->SetEntries(3242.662);
   ratio->SetStats(0);
