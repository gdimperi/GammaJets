...
//=========  (Tue Feb 18 13:01:18 2014) by ROOT version5.32/00
   TCanvas *ptPhot = new TCanvas("ptPhot", "ptPhot",1,1,1000,876);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   ptPhot->SetHighLightColor(2);
   ptPhot->Range(-162.5,-11333.78,1087.5,102004);
...
// ------------>Primitives in pad: pad1
   ...
   ptPhot_data_All->SetBinContent(3,65574);
   ptPhot_data_All->SetBinContent(4,27748);
   ptPhot_data_All->SetBinError(3,256.0742);
   ptPhot_data_All->SetBinError(4,166.5773);
   ptPhot_data_All->SetMinimum(0.1);
   ptPhot_data_All->SetMaximum(367214.4);
   ...
   ptPhot_mc_Bkg_All->SetBinContent(3,46313.27);
   ptPhot_mc_Bkg_All->SetBinContent(4,17149.87);
   ptPhot_mc_Bkg_All->SetBinError(3,139.9483);
   ptPhot_mc_Bkg_All->SetBinError(4,82.95365);
   ptPhot_mc_Bkg_All->SetEntries(509797);
   ...
   ptPhot_mc_Signal_All->SetBinContent(3,14448.63);
   ptPhot_mc_Signal_All->SetBinContent(4,7307.865);
   ptPhot_mc_Signal_All->SetBinError(3,47.17043);
   ptPhot_mc_Signal_All->SetBinError(4,27.13885);
   ptPhot_mc_Signal_All->SetEntries(1617535);
...
// ------------>Primitives in pad: pad2
   ...
   ratio->SetBinContent(3,1.079196);
   ratio->SetBinContent(4,1.134528);
   ratio->SetBinError(3,0.004964003);
   ratio->SetBinError(4,0.007923333);
   ratio->SetMinimum(0.2);
   ratio->SetMaximum(3);
   ratio->SetEntries(56057.49);
   ratio->SetStats(0);
