...
//=========  (Tue Feb 18 13:01:16 2014) by ROOT version5.32/00
   TCanvas *ptPhot = new TCanvas("ptPhot", "ptPhot",1,1,1000,876);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   ptPhot->SetHighLightColor(2);
   ptPhot->Range(-162.5,-1379.432,1087.5,12414.89);
...
// ------------>Primitives in pad: pad1
   ...
   ptPhot_data_EE->SetBinContent(3,7981);
   ptPhot_data_EE->SetBinContent(4,4170);
   ptPhot_data_EE->SetBinError(3,89.33644);
   ptPhot_data_EE->SetBinError(4,64.57554);
   ptPhot_data_EE->SetMinimum(0.1);
   ptPhot_data_EE->SetMaximum(44693.6);
   ptPhot_data_EE->SetEntries(12151);
   ...
   ptPhot_mc_Bkg_EE->SetBinContent(3,3670.639);
   ptPhot_mc_Bkg_EE->SetBinContent(4,1653.05);
   ptPhot_mc_Bkg_EE->SetBinError(3,39.45453);
   ptPhot_mc_Bkg_EE->SetBinError(4,26.06005);
   ptPhot_mc_Bkg_EE->SetEntries(45379);
   ...
   ptPhot_mc_Signal_EE->SetBinContent(3,4140.353);
   ptPhot_mc_Signal_EE->SetBinContent(4,2281.44);
   ptPhot_mc_Signal_EE->SetBinError(3,25.11759);
   ptPhot_mc_Signal_EE->SetBinError(4,14.79158);
   ptPhot_mc_Signal_EE->SetEntries(477019);
   ...
   TLegend *leg = new TLegend(1.754921e-319,5.375434e-321,3.200656e-319,1.184078e-319,NULL,"brNDC");
   leg->SetBorderSize(0);
   leg->SetTextFont(62);
...
// ------------>Primitives in pad: pad2
   ...
   ratio->SetBinContent(3,1.021765);
   ratio->SetBinContent(4,1.059858);
   ratio->SetBinError(3,0.01297088);
   ratio->SetBinError(4,0.01829022);
   ratio->SetMinimum(0.2);
   ratio->SetMaximum(3);
   ratio->SetEntries(8618.462);
   ratio->SetStats(0);
