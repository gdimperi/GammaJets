...
//=========  (Tue Feb 18 13:01:19 2014) by ROOT version5.32/00
   TCanvas *ptPhot = new TCanvas("ptPhot", "ptPhot",1,1,1000,876);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   ptPhot->SetHighLightColor(2);
   ptPhot->Range(-162.5,-2162.741,1087.5,19464.67);
...
// ------------>Primitives in pad: pad1
   ...
   ptPhot_data_EB->SetBinContent(3,12513);
   ptPhot_data_EB->SetBinContent(4,6110);
   ptPhot_data_EB->SetBinError(3,111.8615);
   ptPhot_data_EB->SetBinError(4,78.16649);
   ptPhot_data_EB->SetMinimum(0.1);
   ptPhot_data_EB->SetMaximum(70072.8);
   ptPhot_data_EB->SetEntries(18623);
   ...
   ptPhot_mc_Bkg_EB->SetBinContent(3,5684.585);
   ptPhot_mc_Bkg_EB->SetBinContent(4,2248.709);
   ptPhot_mc_Bkg_EB->SetBinError(3,48.91281);
   ptPhot_mc_Bkg_EB->SetBinError(4,29.99071);
   ptPhot_mc_Bkg_EB->SetEntries(95298);
   ...
   ptPhot_mc_Signal_EB->SetBinContent(3,6804.673);
   ptPhot_mc_Signal_EB->SetBinContent(4,3681.466);
   ptPhot_mc_Signal_EB->SetBinError(3,30.95707);
   ptPhot_mc_Signal_EB->SetBinError(4,18.3404);
   ptPhot_mc_Signal_EB->SetEntries(836234);
   ...
   TLegend *leg = new TLegend(14544.43,14544.43,4.244024e-314,1.5,NULL,"brNDC");
   leg->SetBorderSize(0);
   leg->SetTextFont(62);
...
// ------------>Primitives in pad: pad2
   ...
   ratio->SetBinContent(3,1.001901);
   ratio->SetBinContent(4,1.030324);
   ratio->SetBinError(3,0.01008885);
   ratio->SetBinError(4,0.01452747);
   ratio->SetMinimum(0.2);
   ratio->SetMaximum(3);
   ratio->SetEntries(13201.77);
   ratio->SetStats(0);
